...
<title>Customerscabletv - Eliminacion de registro de Estados</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Eliminar Registro de Estados</a></h3>
							<div class="entry">
								<?php
									...
									if (isset ($_POST['aceptar']))
									{
										...
										$resulatado=log_eliminar_deptos($_GET["id"]);
										if ($resulatado==1)
										{
										...
										{	
												...
												Imposible eliminar el Estado, ya hay registros que dependen de este
												</div>';
										}
										$mostrar_datos=false;
									}
