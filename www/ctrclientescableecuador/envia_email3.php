...
function exportarTablas2($host, $usuario, $pasword, $nombreDeBaseDeDatos)
{
    ...
    return file_put_contents($nombreDelArchivo2, $contenido) !== false;
						...
						//{
						$paso=2;
						exportarTablas("localhost:81", "root", "", "cablefacturas");
						exportarTablas2("localhost:81", "root", "", "cablefacturas");
...
$printer->close();
							...
							echo '<div class="post">
									...
									<div class="g-savetodrive" data-src="http://localhost:81/ctrclientescablefactu/respaldos/cablefacturas_respaldo.sql"   data-filename="ctrclientescablefactu_respaldo.sql"   data-sitename="Cablevision"></div>
