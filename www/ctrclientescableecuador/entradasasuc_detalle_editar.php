...
<title>Customerscabletv - Editar Detalle de Entrada de articulos </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Editar Detalle de INGRESOS de articulos</a></h3>
							<div class="entry">
								<?php
									...
									$bodega=$parametros['3'];
									$tabla=log_obtener_detalle_entradaasuc($codigo_entrada,$_GET["id"]);
									...
									switch ($mostrar_datos)
									{
										case 'get':
											...
											<td><input type="text" class="frm_txt" name="Precio" value="'.$registro["Precio"].'" /></td>
											</tr>
										...
										case 'post':
											...
											if (isset($_POST['Marca'])==false or $_POST['Marca']=="")
											{
												echo '<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#ce2700;">
												Debe seleccionar una Marca para el Detalle de Entrada de Matariales que desea ingresar.
												</div>';
												$insertar=false;
											}
											...
											{
												echo '<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#ce2700;">
												Debe ingresar la cantidad para el Detalle de Entrada de Matariales que desea ingresar.
												</div>';
												$insertar=false;										
											}
											else
											...
											{
												echo '<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#ce2700;">
												Debe ingresar el precio Unitario para el Detalle de Entrada de Matariales que desea ingresar.
												</div>';
												$insertar=false;										
											}
											else
											{
												if(validar_decimales($_POST['Precio'])==0)
												{
												echo '<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#ce2700;">
											...
											if ($insertar==true)
											{
												$resultado=log_actualizar_entrada_detalle($_POST,$codigo_entrada,$_GET['id'],$registro["Cantidad"],$bodega,$registro["Producto"]);
