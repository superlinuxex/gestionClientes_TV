...
<title>Customerscabletv - Eliminar Zona </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Eliminar zona de cobertura</a></h3>
							<div class="entry">
								<?php
									...
									if (isset ($_POST['aceptar']))
									{
										...
										$resulatado=log_eliminar_zona($_GET["id"]);
										if ($resulatado==1)
										{
										...
										{	
											if ($resulatado=='1451')
											{
												...
												No se puede eliminar. Hay clientes en esa zona.
												</div>';
											}
											else
											{
