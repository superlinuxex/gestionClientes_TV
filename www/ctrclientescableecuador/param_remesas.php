...
<title>Customerscabletv - Reporte de remesas de caja chica y de sucursal</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title"><a href="#">Parametros para la Generacion del Reporte remesas</a></h3>
							<div class="entry">
								<?php
									if (isset ($_POST['aceptar']))
									{
										...
										if ($insertar==true)
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=rpt_remesas.php?
									...
									<td>
										<select name="Tipoinfo" class="frm_cmb_long">
											<option value="1" '.(isset($_POST['Tipoinfo'])?($_POST['Tipoinfo']==1?' selected="selected" ':''):'').'>Remesas de sucursal y facturacion</option>
											<option value="2" '.(isset($_POST['Tipoinfo'])?($_POST['Tipoinfo']==2?' selected="selected" ':''):'').'>Remesas a caja chica y gastos</option>
											<option value="3" '.(isset($_POST['Tipoinfo'])?($_POST['Tipoinfo']==3?' selected="selected" ':''):'').'>Remesas en detalle por cada abono a banco</option>
										</select>
									</td>
									</tr>
