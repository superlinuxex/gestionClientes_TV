...
<title>Customerscabletv - Eliminar una devolucion a cliente</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Eliminar Registro de devolucion a clientes</a></h3>
							<div class="entry">
								<?php
									$bodx=$_SESSION["idBodega"];
									require_once("./logica/log_devoclie.php");
									$tabla=log_obtener_devoclie2($_GET["id"],$bodx);
									...
									if (isset ($_POST['aceptar']))
									{
										...
										if($eliminar=="true")
										{
										 $resulatado=log_eliminar_devoclie($_GET["id"],$bodx);
									...
									<tr>
									<td>Factura:</td>
									<td><input type="text" class="frm_txt"  readonly="readonly" name="Factura" value="'.$registro['Factura'].'" /></td>
									</tr>


									<tr>
									<td>Fecha de factura:</td>
									<td><input type="text" class="frm_txt"  readonly="readonly" name="Fechafac" id="Fechafac" value="'.$registro['Fechafac'].'" /></td>
									</tr>
										...
										<td>
										<select name="Tipofac" disabled="true" class="frm_cmb">
										<option value="1" '.($registro['Tipofac']==1?' selected="selected" ':'').'>Factura de consumidor final</option>											
										<option value="2" '.($registro['Tipofac']==2?' selected="selected" ':'').'>Credito fiscal</option>											
										</select>
										</td>
										</tr>
									...
									<td>
									<select name="Codconcep" disabled="true" class="frm_cmb" />
									<option value="">Seleccione un concepto...</option>';
									require_once("./logica/log_devoclie.php");
									$resultado=log_obtener_tipodev_cmb();
										  while ( $fila = mysql_fetch_array($resultado))
										   {
										      if ($fila['Codigo']==$registro['Codconcep'])
										      {
									...
									<td>
									<select name="Empleado" disabled="true" class="frm_cmb" />
