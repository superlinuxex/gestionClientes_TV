...
<title>Customerscabletv - Editar Bodega </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Editar Sucursal</a></h3>
							<div class="entry">
								<?php
									require_once("logica/log_bodegas.php");
									$tabla=log_obtener_bodega($_GET["id"]);
									...
									switch ($mostrar_datos)
									{
										case 'get':
											...
											<tr>
											<td>Empresa a la que pertenece la sucursal:</td>
											<td><input type="text" class="frm_txt" name="Empresa" readonly="readonly" value="'.$registro['Empresa'].'" /></td>
											</tr>
											<tr>
											...
											<tr>
											<td>Dirección:</td>
											<td><input type="text" class="frm_txt_long" name="Ubicacion" value="'.$registro['Ubicacion'].'" /></td>
											</tr>
											<tr>
											
											<tr>
											<td>Nombre del responsable:</td>
											<td><input type="text" class="frm_txt_long" name="Usuario" value="'.$registro['Usuario'].'" /></td>
											</tr>
											<tr>
										...
										case 'post':
											...
											{
												echo '<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#ce2700;">
												Debe seleccionar el Usuario Responsable para la sucursal que desea ingresar.
												</div>';
												$insertar=false;										
											}
											if ($insertar==true)
											{
												$resultado=log_actualizar_bodega($_POST,$_GET['id']);
											...
											<tr>
											<td>Empresa al que pertenece la sucursal:</td>
											<td><input type="text" class="frm_txt" name="Empresa" readonly="readonly" value="'.(isset($_POST['Empresa'])?$_POST['Empresa']:'').'" /></td>
											</tr>
											<tr>
