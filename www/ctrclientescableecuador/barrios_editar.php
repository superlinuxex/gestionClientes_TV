...
<title>Customerscabletv- Editar localidades</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Editar registro de localidades</a></h3>
							<div class="entry">
								<?php
									...
									switch ($mostrar_datos)
									{
										...
										case 'post':
											if (isset($_POST['Codigo'])==false or $_POST['Codigo']=="")
											{
												...
												Debe ingresar el Codigo para la localidad que desea ingresar
												</div>';
												$insertar=false;
											}
											...
											if ($insertar==true)
											{
												$resultado=log_actualizar_barrio($_POST,$_GET['part'],$_GET['s_part'],$_GET['s_part_a'],$_GET['s_part_b']);
											...
											echo '<form method="POST" id="id-form" action="'.$_SERVER["PHP_SELF"].'?part='.$_GET["part"].'&s_part='.$_GET["s_part"].'&s_part_a='.$_GET["s_part_a"].'&s_part_b='.$_GET["s_part_b"].'" >';
											echo '<input type = "hidden" name = "Depto" value = "'.$_GET["part"].'" />';
											echo '<input type = "hidden" name = "Ciudad" value = "'.$_GET["s_part"].'" />';
											echo '<input type = "hidden" name = "Zona" value = "'.$_GET["s_part_a"].'" />';
											echo '<input type = "hidden" name = "Localidad" value = "'.$_GET["s_part_b"].'" />';
											echo '
											Departamento:'.$_GET["part"].'
											Municipio:'.$_GET["s_part"].'
											Canton:'.$_GET["s_part_a"].'
