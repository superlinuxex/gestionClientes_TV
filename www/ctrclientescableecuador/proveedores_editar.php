...
<title>Customerscabletv - Editar Proveedores </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Editar Proveedor</a></h3>
							<div class="entry">
								<?php
								...
								case 'get':
									...
									<td><input type="text" class="frm_txt_long"  name="Contacto" value="'.$registro['Contacto'].'" /></td>
									</tr>
									<tr>
									...
									<td><input type="text" class="frm_txt_long"  name="Contac2" value="'.$registro['Contac2'].'" /></td>
									</tr>
									<tr>

									<tr>
									<td>Area de la empresa para localizar al contacto:</td>
									<td><input type="text" class="frm_txt_long" name="Area" value="'.$registro['Area'].'" /></td>
									</tr>
									<tr>
									...
									<tr>
									<td>Dirección:</td>
									<td><input type="text" class="frm_txt_long" name="Direccion" value="'.$registro['Direccion'].'" /></td>
									</tr>
									<tr>

									<tr>
									<td>Telefonos fijos:</td>
									<td><input type="text" class="frm_txt" name="Telefonos" value="'.$registro['Telefonos'].'" /></td>
									</tr>
									<tr>

									<tr>
									<td>Telefonos moviles:</td>
									<td><input type="text" class="frm_txt" name="Telefonosm" value="'.$registro['Telefonosm'].'" /></td>
									</tr>
									<tr>
									...
									<tr>
									<td>Ciudad:</td>
									<td><input type="text" class="frm_txt_long" name="Ciudad" value="'.$registro['Ciudad'].'" /></td>
									</tr>
									<tr>
									...
									<tr>
									<td>Pais:</td>
									<td><input type="text" class="frm_txt_long" name="Pais" value="'.$registro['Pais'].'" /></td>
									</tr>
									<tr>
									...
									<td><input type="text" class="frm_txt" name="Rfiscal" value="'.$registro['Rfiscal'].'" /></td>
									</tr>
									<tr>
									...
									<tr>
									<td>NIT:</td>
									<td><input type="text" class="frm_txt" name="Nit" value="'.$registro['Nit'].'" /></td>
									</tr>
									<tr>

									<tr>
									<td>ABA:</td>
									<td><input type="text" class="frm_txt" name="Aba" value="'.$registro['Aba'].'" /></td>
									</tr>

									<tr>
									<td>SWIFT:</td>
									<td><input type="text" class="frm_txt" name="Sw" value="'.$registro['Sw'].'" /></td>
									</tr>


									<tr>
									<td>Primer correo electronico:</td>
									<td><input type="text" class="frm_txt_long"  name="Email" value="'.$registro['Email'].'" /></td>
									</tr>
									<tr>

									<tr>
									<td>Segundo correo electronico:</td>
									<td><input type="text" class="frm_txt_long"  name="Email2" value="'.$registro['Email2'].'" /></td>
									</tr>
									<tr>
									...
									<td><input type="text" class="frm_txt_long"  name="Email3" value="'.$registro['Email3'].'" /></td>
									</tr>
									<tr>
									...
									<tr>
									<td>Sitio Web:</td>
									<td><input type="text" class="frm_txt_long" name="Url" value="'.$registro['Url'].'" /></td>
									</tr>
									<tr>
									...
									<tr>
									<td>Codigo postal:</td>
									<td><input type="text" class="frm_txt" name="Cpostal" value="'.$registro['Cpostal'].'" /></td>
									</tr>
									<tr>
									...
									<td><input type="text" class="frm_txt" name="Creditod" value="'.$registro['Creditod'].'" /></td>
									</tr>
									<tr>

									<tr>
									<td>Limite de crédito:</td>
									<td><input type="text" class="frm_txt" name="Creditol" value="'.$registro['Creditol'].'" /></td>
									</tr>
									<tr>

									<tr>
									<td>Porcentaje de descuento:</td>
									<td><input type="text" class="frm_txt" name="Descu" value="'.$registro['Descu'].'" /></td>
									</tr>
									<tr>
									...
									<td><input type="text" class="frm_txt_long" name="Obs" value="'.$registro['Obs'].'" /></td>
									</tr>
									<tr>
										...
										case 'post':
											...
											if ($insertar==true)
											{
												$resultado=log_actualizar_proveedor($_POST,$_GET['id']);
									...
									<tr>
									<td>Ciudad:</td>
									<td><input type="text" class="frm_txt_long" name="Ciudad" value="'.(isset($_POST['Ciudad'])?$_POST['Ciudad']:'').'" /></td>
									</tr>
									<tr>
