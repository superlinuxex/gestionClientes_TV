...
<title>Customerscabletv - Eliminar Artículo del Detalle</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Eliminar Artículo del Detalle de la entrada</a></h3>
							<div class="entry">
								<?php
									...
									{										
										$resultado=log_eliminar_entradaasuc_detalle($codigo_entrada,$_GET['id'],$registro["Cantidad"],$bodega,$registro["Producto"],$registro["Estadocod"]);
									...
									if ($mostrar_datos==true)
									{
										...
										<td>Articulo:</td>
										<td>
											<select name="Producto" disabled="disabled" class="frm_cmb" />
										...
										<td><input type="text" class="frm_txt" readonly="readonly" name="Estado" value="'.$registro["Estado"].'" /></td>
										</tr>

										<tr>
										<td>Unidad de Medida de despacho:</td>
