...
<title>Customerscabletv - Editar Poblaciones</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Editar registro de Poblaciones</a></h3>
							<div class="entry">
								<?php
									...
									switch ($mostrar_datos)
									{
										...
										case 'post':
											if (isset($_POST['Codigo'])==false or $_POST['Codigo']=="")
											{
												...
												Debe ingresar el Codigo para el canton a que desea ingresar
												</div>';
												$insertar=false;
											}
											...
											{
												echo '<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#ce2700;">
												Debe ingresar el Nombre para la zona que a desea ingresar
												</div>';
												$insertar=false;
											}
											if ($insertar==true)
											{
												$resultado=log_actualizar_canton($_POST,$_GET['part'],$_GET['s_part'],$_GET['s_part_a']);
