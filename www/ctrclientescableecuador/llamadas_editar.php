...
<title>Customerscabletv- Editar actividad tecnica programada </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Editar Registro de llamada a clientes</a></h3>
							<div class="entry">
								<?php
								...
								if (intval(substr($registro['Fechaeje'],5,2))!=0)
								{
									...
									$insertar=false;
										...
										if (isset($_POST['Empleado'])==false or $_POST['Empleado']=="")
										{
											...
											if ($insertar==true)
											{
												$resultado=log_actualizar_llamadas($_POST,$_GET['id'],$bodx);
