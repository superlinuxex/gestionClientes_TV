		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Generar reportes de facturacion</h3>
							<div class="entry">
								<?php
									...
									if (isset ($_POST['aceptar']))
									{
										...
										if ($insertar==true)
										{
											...
											&ser= '.(isset($_POST['Servicio'])?$_POST['Servicio']:'').'">';
											exit;
											unset($_POST); 
										}										
									}
									...
									if (isset ($_POST['aceptar2']))
									{
										...
										if ($insertar==true)
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=rpt_ventasdeta1spdf.php?
									...
									if (isset ($_POST['export_data']))
									{
										...
										if ($insertar==true)
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=rpt_ventasdeta1sexe.php?
									...
									<td>
										<select name="Tipoinfo" class="frm_cmb_long">
											<option value="2" '.(isset($_POST['Tipoinfo'])?($_POST['Tipoinfo']==2?' selected="selected" ':''):'').'>Ingresos totales en facturas de clientes</option>
										</select>
									</td>
									</tr>
									...
									<tr>
									<td>Filtrar por tipo de servicio cobrado:</td>
									<td>
									...
									<input  type="submit" id="export_data" value="Exportar a excel"  class="frm_btn" name="export_data"/>
