...
<title>Customerscabletv - Eliminar Planes </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Eliminar Plan</a></h3>
							<div class="entry">
								<?php
									...
									if (isset ($_POST['aceptar']))
									{
										...
										$resulatado=log_eliminar_planes($_GET["id"]);
										if ($resulatado==1)
										{
										...
										{	
											if ($resulatado=='1451')
											{
												...
												No se puede eliminar este plan pues ya tiene movimientos.
												</div>';
											}
											else
											{
									...
									if ($mostrar_datos==true)
									{
										...
										<td><input type="text" readonly="readonly" class="frm_txt_long" name="Costo" value="'.$registro['Costo'].'" /></td>
										</tr>
										<tr>

										<td>PERIODO DE VIGENCIA</td>
										<tr>
										<td>Fecha inicial:</td>
										<td><input type="text" readonly="readonly" class="frm_txt" name="Fechai" value="'.$registro['Fechai'].'" /></td>
										</tr>
										<tr>
										...
										<tr>
										<td>Fecha final:</td>
										<td><input type="text" readonly="readonly" class="frm_txt" name="Fechaf" value="'.$registro['Fechaf'].'" /></td>
										</tr>
										<tr>
									...
									<td>
									<select name="Bodega" disabled="true" class="frm_cmb" />
