...
<title>Customerscabletv - Agregar programacion de pagos mensuales de clientes </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Agregar programacion de pagos mensuales de clientes</a></h3>
							<div class="entry">
								<?php
							     ...
							     else
							     {
							      $codclie=$_GET['idcliente'];
									...
									if (isset ($_POST['aceptar']))
									{
										...
										if (isset($_POST['Fechaf'])==false or $_POST['Fechaf']=="")
										{
											echo '<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#ffffff;">
										...
										if (isset($_POST['Pagado'])==false or $_POST['Pagado']=="")
										{
											echo '<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#ffffff;">
											Debe especificar si este periodo ya fue pagado, el NO PAGADO es el que tomara la proxima factura
											</div>';
											$insertar=false;
										}
										...
										if ($insertar==true)
										{
											$resulatado=log_insertar_peridetalle($_POST,$bodega);
                                                                                        if($resulatado==0)
											{
											echo'<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#ffffff;">
									...
									<div style="background:url(imagenes/msg_yelow.png) no-repeat; padding:10px 10px 10px 10px; Color:#ce2700;">
									NOTA Debe especificar periodos con rangos de fecha con el mismo numero del dia, a menos que sea dias de servicio											
									<div style="background:url(imagenes/msg_yelow.png) no-repeat; padding:10px 10px 10px 10px; Color:#ce2700;">
									Ejemplo: Fecha inicio: 01-10-2013 a Fecha final: 01-11-2013
									...
									<td>
										<select name="Pagado" class="frm_cmb">
											<option value="0" '.(isset($_POST['Pagado'])?($_POST['Pagado']==0?' selected="selected" ':''):'').'>NO</option>
											<option value="1" '.(isset($_POST['Pagado'])?($_POST['Pagado']==1?' selected="selected" ':''):'').'>SI</option>
										</select>
									</td>
									</tr>
