		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Agregar urbanizaciones o caserios </a></h3>
							<div class="entry">
								<?php
									...
									if (isset ($_POST['cancelar']))
									{
										...
										URL=caserios.php?part='.$_GET["part"].'&s_part='.$_GET["s_part"].'&s_part_a='.$_GET["s_part_a"].'&s_part_b='.$_GET["s_part_b"].'">';
										exit;    
									}
									if (isset ($_POST['aceptar']))
									{
										...
										if ($insertar==true)
										{
											$caserio_existe = log_validar_existencia_caserio($_GET["part"],$_GET["s_part"],$_GET["s_part_a"],$_GET["s_part_b"],$_POST['Codigo']);
											if ($caserio_existe==true)
											{
												echo '<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#ce2700;">
												El codigo de la urbanizacion ya existe 
												</div>';
												$insertar=false;
											}
										}
										...
										if ($insertar==true)
										{
											$resulatado=log_insertar_caserios($_POST);
									...
									action="'.$_SERVER["PHP_SELF"].'?part='.$_GET["part"].'&s_part='.$_GET["s_part"].'&s_part_a='.$_GET["s_part_a"].'&s_part_b='.$_GET["s_part_b"].'" >';
