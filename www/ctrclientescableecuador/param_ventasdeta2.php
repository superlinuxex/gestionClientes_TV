...
<title>Customerscabletv - Reporte de ventas con credito fiscal en sucursales</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Generar Reporte de ventas con credito fiscal en sucursal actual</h3>
							<div class="entry">
								<?php
									if (isset ($_POST['aceptar']))
									{
										...
										if ($insertar==true)
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=rpt_ventasdeta2s.php?
