...
<title>Customercabletv- Editar motivo de desconexion </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Editar Motivo de desconexion</a></h3>
							<div class="entry">
								<?php
									...
									switch ($mostrar_datos)
									{
										...
										case 'post':
											...
											if ($insertar==true)
											{
												$resultado=log_actualizar_motidesco($_POST,$_GET['id']);
