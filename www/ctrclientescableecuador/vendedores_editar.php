...
<title>Customerscabletv- Editar registro de empleados</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Editar Registro del Empleado</a></h3>
							<div class="entry">
								<?php
									...
									<tr>
									<td>Nombres:</td>
									<td><input type="text" class="frm_txt_long" name="Nombres" value="'.$registro['Nombres'].'" /></td>
									</tr>

									<tr>
									<td>Apellidos:</td>
									<td><input type="text" class="frm_txt_long" name="Apellidos" value="'.$registro['Apellidos'].'" /></td>
									</tr>
									...
									<tr>
									<td>Teléfono:</td>
									<td><input type="text" class="frm_txt" name="Telefono" value="'.$registro['Telefono'].'" /></td>
									</tr>

									<tr>
									<td>Cargo:</td>
									<td><input type="text" class="frm_txt_long" name="Cargo" value="'.$registro['Cargo'].'" /></td>
									</tr>
									...
									while ( $fila = mysql_fetch_array($resultado))
										...
										case 'post':
											if (isset($_POST['Nombres'])==false or $_POST['Nombres']=="")
											{
												...
												Debe ingresar el nombre del Vendedor que desea ingresar
												</div>';
												$insertar=false;
											}
											...
											if ($insertar==true)
											{
												$resultado=log_actualizar_vendedores($_POST,$_GET['id'],$bodx);
									...
									<td>
										<select name="Estado" class="frm_cmb">
											<option value="1" '.(isset($_POST['Estado'])?($_POST['Estado']==1?' selected="selected" ':''):'').'>ACTIVO</option>
											<option value="2" '.(isset($_POST['Estado'])?($_POST['Estado']==2?' selected="selected" ':''):'').'>INACTIVO</option>
										</select>
									</td>
									</tr>
