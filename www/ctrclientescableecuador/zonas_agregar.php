...
<title>Customerscabletv- Agregar Zonas </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Agregar Zonas de Cobertura</a></h3>
							<div class="entry">
								<?php
									...
									{
										echo '<META HTTP-EQUIV="Refresh" Content="0; URL=zonas.php">';    
										exit;    
									}
									if (isset ($_POST['aceptar']))
									{
										...
										{
											echo '<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#ce2700;">
											Debe ingresar el Nombre para la zona que desea ingresar
											</div>';
											$insertar=false;
										}
										if ($insertar==true)
										{
											$resultado=log_insertar_zona($_POST);
                 									IF($resultado==1){
											...
											{
											 echo'<div style="background:url(imagenes/msg_green.png) no-repeat; padding:10px 10px 10px 10px; Color:#6da827;">
											 Registro imposible de adicionar.	
											</div>';
											}
											unset($_POST); 
										echo '<META HTTP-EQUIV="Refresh" Content="0; URL=zonas.php">';    
