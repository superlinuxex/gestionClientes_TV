...
<title>S I C I O - Editar Proyecto </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h2 class="title">Editar Proyecto</a></h2>
							<div class="entry">
								<?php
									...
									switch ($mostrar_datos)
									{
										case 'get':
											...
											<td>División:</td>
											<td>
												<select name="Division" disabled="true" class="frm_cmb"/>
											...
											<tr>
											<td>Presupuesto:</td>
											<td><input type="text" class="frm_txt" name="Presupuesto" value="'.$registro['Presupuesto'].'" onBlur="this.value=formatCurrency(this.value);"/></td>
											</tr>

											<tr>
											<td>Ubicación:</td>
											<td><input type="text" class="frm_txt" name="Ubicacion" value="'.$registro['Ubicacion'].'" /></td>
											</tr>
										...
										case 'post':
											if (isset($_POST['Codigo'])==false or $_POST['Codigo']=="")
											{
												...
												Debe ingresar el Codigo para el proyecto que desea ingresar
												</div>';
												$insertar=false;
											}
											...
											if ($insertar==true)
											{
												$resultado=log_actualizar_proyecto($_POST,$_GET['id']);
