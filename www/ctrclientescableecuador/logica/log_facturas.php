...
function log_obtener_ventausuario($elusuario)
{
	return dat_obtener_ventausuario($elusuario);
	exit;
}
function log_obtener2_ventausuario($elusuario,$bodega,$fecha1)
{
	return dat_obtener2_ventausuario($elusuario,$bodega,$fecha1);
	exit;
}

function log_obtener3_ventausuario($elusuario,$bodega,$fecha1)
{
	return dat_obtener3_ventausuario($elusuario,$bodega,$fecha1);
	exit;
}

function log_aumentar_ventausuario($elusuario,$montousuario,$bodega,$fecha1)
{
	return dat_aumentar_ventausuario($elusuario,$montousuario,$bodega,$fecha1);
	exit;
}

function log_restar_ventausuario($elusuario,$montousuario,$bodega,$fecha1)
{
	return dat_restar_ventausuario($elusuario,$montousuario,$bodega,$fecha1);
	exit;
}

function log_ve_ventausuario($elusuario,$bodega)
{
	return dat_ve_ventausuario($elusuario,$bodega);
	exit;
}

function log_actualizar2_ventausuario($elusuario,$montousuario,$bodega,$fecha1,$observa,$montoinicial)
{
	return dat_actualizar2_ventausuario($elusuario,$montousuario,$bodega,$fecha1,$observa,$montoinicial);
	exit;
}

function log_actualizar3_ventausuario($elusuario,$montousuario,$bodega,$fecha1,$observa,$montoinicial)
{
	return dat_actualizar3_ventausuario($elusuario,$montousuario,$bodega,$fecha1,$observa,$montoinicial);
	exit;
}


function log_actualizar_ventausuario($elusuario,$montousuario,$bodega)
{
	return dat_actualizar_ventausuario($elusuario,$montousuario,$bodega);
	exit;
}
...
function log_actualizar_facturas_detalle($datos,$encabezado,$registro)
{
	return dat_actualizar_facturas_detalle($datos,$encabezado,$registro);
	exit;
}
...
function log_eliminarglob_factura($datos,$bodega)
{
	return dat_eliminarglob_factura($datos,$bodega);
	exit;
}
