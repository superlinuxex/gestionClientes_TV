...
function log_insertar_existencia($datos,$bodega,$producto,$cant,$codentrada,$precio,$estado,$Encabezado)
{
	return dat_insertar_existencia($datos,$bodega,$producto,$cant,$codentrada,precio,$estado,$Encabezado);
	exit;
}
