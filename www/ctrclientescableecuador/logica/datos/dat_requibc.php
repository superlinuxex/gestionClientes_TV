...
global $parametros , $conexion ;
    $sentencia = "Select idarticulos Producto, case estado_art when 1 then 'Nuevo' 
          when 2 then 'Usado' end Estado, unidadmedc Medida, cantidad Cantidad, precio_unit 'Precio'
					from entradas_deta
...
function dat_insertar_existencia($bodega,$producto,$cant,$codentrada,$precio)
{
global $parametros , $conexion ;
...
//Calculando el costo promedio para la compra actual
//Pendiente*****
...
//inserta un registro en la tabla de Existencia o lo actualiza en el caso que ya tenga valor
	...
	else
	{
		...
		$sentencia="insert into existenciaprod (idarticulos,idbodegas,descripcion,cantidad,tipo_art,unidadmed,costo) VALUES ('".$producto."','".$bodega."','".$xxdesc."','".$cantreal."','".$xxtipo."','".$xxunidad."','".$xxunidad."','".$costoprom."');";
		$retorno=mysql_query($sentencia);
	}
...
function dat_eliminar_entrada_detalle($cod_encabezado, $cod_detalle,$cant_ant,$bodega,$producto)
{
global $parametros , $conexion ;
//convirtiendo unidades en entrada a unidades de salida
        $sentencia="select embalaje,embasino from  articulos where idarticulos='".$producto."'";
