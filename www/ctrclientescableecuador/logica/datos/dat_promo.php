...
function dat_obtener_promo_cmb()
{
...
function dat_obtener_promo($comienzo, $cant)
{
	global $parametros , $conexion ;
...
function dat_obtener_num_promo()
{
	global $parametros , $conexion ;
...
function dat_insertar_promo($datos)
{
global $parametros , $conexion ;
...
function dat_eliminar_promo($id)
{
global $parametros , $conexion ;
...
function dat_actualizar_promo($datos, $id)
{
global $parametros , $conexion ;
