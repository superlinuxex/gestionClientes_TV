...
function dat_obtener_equi($comienzo, $cant)
{
	global $parametros , $conexion ;
...
function dat_insertar_equi($datos)
{
global $parametros , $conexion ;
...
function dat_actualizar_equi($datos, $id)
{
global $parametros , $conexion ;
