...
<body>
	<div>
		...
		<div style="position:absolute;left:100px;top:50px;width:800px;height:37px;text-align:center;z-index:0;">
			<span style="color:#000000;font-family:Arial;font-size:36px;"><strong>Reporte de clientes desconectados con nodo aun instalado</strong></span>
		</div>
		...
		<div style="position:absolute;left:10px;top:100px;width:350px;height:22px;z-index:1;">
			<span style="color:#000000;font-family:Arial;font-size:20px;"><strong>Sucursal: </strong>'.$nom_bodega.'</span>
		</div>
		...
		<table cellspacing="0" class="Tabla1" style="position:absolute;left:1px;top:130px;width:98%;">
			<tr>
				...
				<td class="FilaN" style="height: 22px"><strong>F.Pago</strong></td>
				<td class="FilaN" style="height: 22px";text-align:left><strong>F.Desco.</strong></td>
				<td class="FilaN" style="height: 22px"><strong>Direccion</strong></td>
				<td class="FilaNF" style="height: 22px;text-align: center;padding-right:0px;"><strong>Observaciones</strong></td>
			</tr>';	
                        $cuentafila=1;
                        $sumalineas=0;
                        $sumamora=0;
...
$content .= '
					<tr>
						<td class="FilaNI" style="height: 22px;width:50px; font-size:16px; text-align: center">'.$cliente.'</td>
						<td class="FilaN" style="height: 22px;width:100px; font-size:16px; text-align: left">'.$ncliente.'</td>
						<td class="FilaN" style="height: 22px;width:50px; font-size:16px; text-align: left">'.$xfechaul.'</td>
						<td class="FilaN" style="height: 22px;width:50px; font-size:16px; text-align: left">'.$xfechai.'</td>
						<td class="FilaN" style="height: 22px;width:160px; font-size:16px; text-align: left">'.$xdireccion.'</td>
						<td class="FilaNF" style="height: 22px;font-size:16px;width:90px; text-align:left">'.$xobs.'</td>
					</tr>';	
...
$pdf->lastPage();
$pdf->output('pdfRep_des_con_nodo.pdf', 'I');
