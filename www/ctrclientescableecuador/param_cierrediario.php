...
<title>Customerscabletv - Resumen diario de oficina</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title"><a href="#">Parametros para generar el reporte de resumen diario</a></h3>
							<div class="entry">
								<?php
...
if (isset ($_POST['aceptar2']))
{
										...
										if ($insertar==true)
										{
  										        echo '<META HTTP-EQUIV="Refresh" Content="0; URL=mapageo3.php?
...
if (isset ($_POST['aceptar3']))
{
										...
										if ($insertar==true)
										{
  										        echo '<META HTTP-EQUIV="Refresh" Content="0; URL=mapageo2.php?
											fd='.(isset($_POST['FechaD'])?$_POST['FechaD']:'').'
											&ti='.(isset($_POST['Tipoinfo'])?$_POST['Tipoinfo']:'').'
											&bod= '.(isset($_POST['Bodega'])?$_POST['Bodega']:'').'">';
											exit;
									...
									if (isset ($_POST['aceptar']))
									{
										...
										if ($insertar==true)
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=rpt_cierrediario.php?
									...
									<tr>
									<td>Proceso a realizar:</td>
									<td>
										<select name="Tipoinfo" class="frm_cmb">
											<option value="1" '.(isset($_POST['Tipoinfo'])?($_POST['Tipoinfo']==1?' selected="selected" ':''):'').'>Resumen Diario</option>
										</select>
									</td>
									</tr>

									<tr>
									<td>Especifique la fecha:</td>
									<td>
									...
									<input  type="submit" value="XML P/Mapa Geo"  class="frm_btn" name="aceptar2"/>
									<input  type="submit" value="Crear Mapa Geo"  class="frm_btn" name="aceptar3"/>
									</td>
									</tr>
									</table>
									</form>';
