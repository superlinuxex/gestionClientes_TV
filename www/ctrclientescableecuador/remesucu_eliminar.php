...
<title>Customerscabletv - Eliminar remesas de sucursal al banco</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Eliminar remesa de sucursal a banco</a></h3>
							<div class="entry">
								<?php
									$xbodega=$_SESSION["idBodega"];

									require_once("./logica/log_remesucu.php");
									$tabla=log_obtener_remesucu($_GET["id"],$xbodega);
									...
									if (isset ($_POST['aceptar']))
									{
 									$insertar=true;
										...
										if($insertar==true)
										{
									 	 $resulatado=log_eliminar_remesucu($_GET["id"],$xbodega);
										 if ($resulatado==1)
										  {
									...
									<td><input type="text" class="frm_txt" id="Fechadia" name="Fechadia" readonly="readonly" value="'.$registro['Fechadia'].'" /></td>
									</tr>
									<tr>
