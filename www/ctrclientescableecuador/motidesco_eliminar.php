...
<title>Customercabletv- Eliminar motivos de desconexion </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Eliminar motivos</a></h3>
							<div class="entry">
								<?php
									require_once("./logica/log_motidesco.php");
									$tabla=log_obtener_motidescouno($_GET["id"]);
									$registro=mysql_fetch_array($tabla);
									$mostrar_datos=true;
									if (isset ($_POST['cancelar']))
									{
										echo '<META HTTP-EQUIV="Refresh" Content="0; URL=motidesco.php">';    
										exit;    
									}
									if (isset ($_POST['aceptar']))
									{
										
										$resulatado=log_eliminar_motidesco($_GET["id"]);
										if ($resulatado==1)
										{
										...
										{	
											if ($resulatado=='1451')
											{
												...
												No se puede eliminar eeste motivo pues ya tiene movimientos.
												</div>';
											}
											else
											{
									...
									if ($mostrar_datos==true)
									{
										...
										<tr>
										<td>Nombre o descripcion del motivo:</td>
