...
<title>Customerscabletv - Eliminar Caserios</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Eliminar urbanizacion o caserio</a></h3>
							<div class="entry">
								<?php
									...
									{
										echo '<META HTTP-EQUIV="Refresh" Content="0; URL=caserios.php?part='.$_GET["part"].'&s_part='.$_GET["s_part"].'&s_part_a='.$_GET["s_part_a"].'&s_part_b='.$_GET["s_part_b"].'&s_part_c='.$_GET["s_part_c"].'">';   
										exit;    
									}
									if (isset ($_POST['aceptar']))
									{
									      $resultado=dat_validar_existencia_caserio_b1($_GET["part"],$_GET["s_part"],$_GET["s_part_a"],$_GET["s_part_b"],$_GET["s_part_c"]);
									      if ($resultado)
										{
										  echo'<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#ce2700;">
										  No se puede eliminar este caserio, ya existen clientes con ese lugar
										  </div>';
										}
										else
										{

										 $resulatado=log_eliminar_caserio($_GET["part"],$_GET["s_part"],$_GET["s_part_a"],$_GET["s_part_b"],$_GET["s_part_c"]);
