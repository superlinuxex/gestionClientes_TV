		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title"><a href="#">Parametros para la Generacion del Reporte de clientes candidatos a desconectar</a></h3>
							<div class="entry">
								<?php
...
if(isset($_POST["export_data"])) {
		...
		if ($insertar==true)
		{
		echo '<META HTTP-EQUIV="Refresh" Content="0; URL=rpt_repocortaexcel.php?
		...
		unset($_POST); 
									...
									if (isset ($_POST['aceptar']))
									{
										...
										if ($insertar==true)
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=rpt_debemasde1.php?
									...
									if (isset ($_POST['aceptar2']))
									{
										...
										if ($insertar==true)
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=rpt_debemasde1_pdf.php?
									...
									<input type="text"  name="FechaD"  hidden="true" class="frm_txt" value="'.$dia1.'">
									<input type="text"  name="FechaH"  hidden="true" class="frm_txt" value="'.$dia2.'">
