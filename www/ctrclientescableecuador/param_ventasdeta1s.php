		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Generar Reporte de facturacion en sucursal</h3>
							<div class="entry">
								<?php
									...
									if (isset ($_POST['aceptar']))
									{
										...
										if ($insertar==true)
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=rpt_ventasdeta1s.php?
									...
									<td>
										<select name="Tipoinfo" class="frm_cmb_long">
											<option value="1" '.(isset($_POST['Tipoinfo'])?($_POST['Tipoinfo']==1?' selected="selected" ':''):'').'>Datos del encabezado de la factura</option>
											<option value="2" '.(isset($_POST['Tipoinfo'])?($_POST['Tipoinfo']==2?' selected="selected" ':''):'').'>Datos del detalle de la factura</option>
											<option value="3" '.(isset($_POST['Tipoinfo'])?($_POST['Tipoinfo']==3?' selected="selected" ':''):'').'>Datos del encabezado del comprobante del credito fiscal</option>
											<option value="4" '.(isset($_POST['Tipoinfo'])?($_POST['Tipoinfo']==4?' selected="selected" ':''):'').'>Datos del detalle del comprobante del credito fiscal</option>
											<option value="5" '.(isset($_POST['Tipoinfo'])?($_POST['Tipoinfo']==5?' selected="selected" ':''):'').'>Facturas anuladas</option>
											<option value="6" '.(isset($_POST['Tipoinfo'])?($_POST['Tipoinfo']==6?' selected="selected" ':''):'').'>Facturacion de cuotas mensuales</option>
										</select>
									</td>
									</tr>
