		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Devoluciones de materiales por Técnicos a sucursal</a></h3>
							<div class="entry">
								<div id="itsthetable">
									<form method="POST" id="id-form" action="entradasasuc_encabezado.php" >
								...
								<div id="itsthetable" >
									<?php
									 echo '
									 CONSULTE INGRESOS EN UN RANGO DE FECHAS
										...
										if (isset ($_POST['Buscar']))
										 {
											 ...
											 $total_registros=log_obtener_num_entradasasuc_filtro($_SESSION["idBodega"],(isset($_POST['FechaD'])?$_POST['FechaD']:''),(isset($_POST['FechaH'])?$_POST['FechaH']:''));
											 ...
											 $entradas=log_obtener_entradasasuc_filtro($_SESSION["idBodega"],$comienzo,$_SESSION["cant_reg_pag"],(isset($_POST['FechaD'])?$_POST['FechaD']:''),(isset($_POST['FechaH'])?$_POST['FechaH']:''));
											 $campos = array("Movim","Vale de salida","Fecha","Tecnico que devuelve");										
											 crear_tabla($entradas, $campos,'Entradas','entradasasuc.php',false,"entradasasuc_encabezado_editar.php",
											 "entradasasuc_encabezado_eliminar.php","entradasasuc_ver_detalle.php","entradasasuc_agregar.php");
											 echo "<div style=\"padding:15px;\" align=\"center\">";
											 paginacion ($num_pag,$total_registros,"entradasasuc.php?pagina=");
											 echo"</div>";   
										 }
										 else
										 {
											require_once("./logica/log_entradasasuc.php");
											include ("./utils/crear_tabla.php");
											$total_registros=log_obtener_num_entradasasuc($_SESSION["idBodega"],'');
											if(!isset($_GET["pagina"])){
												$comienzo = 0;
												$num_pag = 1;
											}
											...
											$entradas=log_obtener_entradasasuc($comienzo,$_SESSION['cant_reg_pag']+75,$_SESSION["idBodega"],'');
											$campos = array("Movim","Vale de salida","Fecha","Tecnico que devuelve");										
											crear_tabla($entradas, $campos,'Entradas','entradasasuc.php',false,"entradasasuc_encabezado_editar.php",
											"entradasasuc_encabezado_eliminar.php","entradasasuc_ver_detalle.php","entradasasuc_agregar.php");
											echo "<div style=\"padding:15px;\" align=\"center\">";
