...
.FilaNI {
	...
	border-bottom: 1pt no-solid black;
}
.FilaNIS {
	font-weight: normal;
	color: black;
...
<body>
	<div>
	<table cellspacing="0" class="Tabla1" style="position:absolute;left:0px;top:100px;width:98%;">
			<div style="position:absolute;left:100px;top:5px;width:800px;height:37px;text-align:center;z-index:0;">
			<span style="color:#000000;font-family:Arial;font-size:35px;"><strong>Clientes con uno o mas meses pendientes de pago              Fecha:</strong>'.$_GET['fd'].'</span>
			</div>
			<tr>
				<td class="FilaNIS" style="height: 22px;top:10px;font-size:26px; left:1px;width:900px"><strong>No.&nbsp;&nbsp;&nbsp; Nombres&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Apellidos&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Direccion&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Telefono&nbsp;&nbsp;&nbsp; Sect. Caja Meses/Dias Desde&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Total&nbsp;&nbsp;&nbsp;&nbsp;SiPagaHoy</strong></td>
			</tr>';	
			...
			if( mysql_num_rows($resultadofin)!=0)
	  		 ...
	  		 while ( $filad = mysql_fetch_array($resultadofin))
			 {
		          ...
		          $ncliente=$filad['nombre'];
                          $acliente=$filad['apellido'];
 		          $xdui=$filad['nit'];
 		          $xsector=$filad['zona'];
			  ...
			  $xapagar=$filad['parametroapa'];
                          $xdiaspendi=$filad['dias_reconexion'];
		          $xmesespen=$filad['parametrompendi'];
                          if($filad['dias_reconexion']>0)
				{
                                 $xmesespen=$xmesespen-1;
				}
$xapagartot=$xapagar;
//if($xmesespen==1 and $xdiaspendi==0)
//{
  //evalua que plan tiene para quitar el descuento por pagar el 1 o el 2 del mes en curso
  if($plancliente=="0100O1OO121")
   {
   if((substr($fechadehoy,0,2)=="01" or substr($fechadehoy,0,2)=="02")) 
     {
      $xapagartot=$xapagar-50;
     }	
   }	
  if($plancliente=="0401O822121")
   {
    if((substr($fechadehoy,0,2)=="01" or substr($fechadehoy,0,2)=="02")) 
     {
      $xapagartot=$xapagar-50;
  ...
  if($plancliente=="0501O822121")
   {
    if((substr($fechadehoy,0,2)=="01" or substr($fechadehoy,0,2)=="02")) 
     {
      $xapagartot=$xapagar-100;
     }	
   }	
  if($plancliente=="0602O622121")
   {
    if((substr($fechadehoy,0,2)=="01" or substr($fechadehoy,0,2)=="02")) 
     {
...
$content .= '
    <tr>
    <td style="position:absolute;left:1px;top:'.$cuentalin.'px;width:900px;height:37px">No.&nbsp;&nbsp;&nbsp; Nombres&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Apellidos&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Direccion&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Telefono&nbsp;&nbsp;&nbsp;Sect.Caja Meses/Dias Desde&nbsp;&nbsp;&nbsp;&nbsp;Total&nbsp; SiPagaHoy</td>
    </tr>';
//    $cuentalin=$cuentalin+20;
//$content .= '
//    <tr>
//    <td style="position:absolute;left:1px;top:'.$cuentalin.'px;width:605px;height:37px">___________________________________________________________________________________________________________________________________</td>
//    </tr>';
    }
    $cuentalin=$cuentalin+20;
    $inicio=2;
$content .= '
    <tr>
    <td style="position:absolute;left:1px;top:'.$cuentalin.'px;width:30px;height:37px;font-size:26px;text-align:left">'.$correlativo.'</td>
    <td style="position:absolute;left:100px;top:'.$cuentalin.'px;width:50px;height:37px;font-size:26px;text-align:left">'.$ncliente.'</td>
    <td style="position:absolute;left:200px;top:'.$cuentalin.'px;width:50px;height:37px;font-size:26px;text-align:left">'.$acliente.'</td>
    <td style="position:absolute;left:350px;top:'.$cuentalin.'px;width:110px;height:37px;font-size:26px">'.$xdireccion.' - '.$xrefer.'</td>
    <td style="position:absolute;left:500px;top:'.$cuentalin.'px;width:60px;height:37px;font-size:26px">'.$xtel.' - '.$xcel.'</td>
    <td style="position:absolute;left:600px;top:'.$cuentalin.'px;width:20px;height:37px;font-size:26px">'.$xsector.'</td>
    <td style="position:absolute;left:650px;top:'.$cuentalin.'px;width:20px;height:37px;font-size:26px">'.$xcaja.'</td>
    <td style="position:absolute;left:700px;top:'.$cuentalin.'px;width:20px;height:37px;font-size:26px">'.$xmesespen.'</td>
    <td style="position:absolute;left:760px;top:'.$cuentalin.'px;width:20px;height:37px;font-size:26px">'.$xdiaspendi.'</td>
    <td style="position:absolute;left:800px;top:'.$cuentalin.'px;width:60px;height:37px;font-size:26px">'.$ttfecha1.' A '.$ttfecha2.'</td>
    <td style="position:absolute;left:850px;top:'.$cuentalin.'px;width:60px;height:37px;font-size:26px">'.$xapagar.'</td>
    <td style="position:absolute;left:880px;top:'.$cuentalin.'px;width:60px;height:37px;font-size:26px">'.$xapagartot.'</td>
    </tr>';
    $cuentalin=$cuentalin+110;
...
$pdf->lastPage();
$pdf->output('pdfRep_avisoscf.pdf', 'I');
?>
