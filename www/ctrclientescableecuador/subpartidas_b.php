		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h2 class="title">Catálogo de Sub-Partidas 'B'</a></h2>
							...
							<div class="entry">
								...
								<?php
										...
										echo "<h3 class=\"title\">Datos de la Sub-Partidas 'A'</a></h3>";
										$subpartidas_a=log_obtener_subpartida_a_sub($_GET["part"],$_GET["div"],$_GET["pro"],$_GET["s_part"],$_GET["s_part_a"]);
										$campos = array("Codigo","Sub-Partida","Division","Proyecto","Nombre","Cargos","Abonos","Saldo");
										crear_tabla($subpartidas_a, $campos,'detalle_partida','',false,"","","","");
																				
										echo "<br/><h3 class=\"title\">Sub-Partidas 'B'</a></h3>";
										$parm='?part='.$_GET["part"].'&div='.$_GET["div"].'&pro='.$_GET["pro"].'&s_part='.$_GET["s_part"].'&s_part_a='.$_GET["s_part_a"].'&s_part_b=';
										$subpartidas_b=log_obtener_subpartidas_b($_GET["part"],$_GET["div"],$_GET["pro"],$_GET["s_part"],$_GET["s_part_a"]);
										$campos = array("Codigo","Sub-Partida A","Division","Proyecto","Nombre","Cargos","Abonos","Saldo");
										crear_tabla($subpartidas_b, $campos,'subpartidas_b','subpartidas_b.php',false,"subpartidas_b_editar.php".$parm,
										"subpartidas_b_eliminar.php".$parm,"","subpartidas_b_agregar.php?part=".$_GET["part"].'&div='.$_GET["div"].'&pro='.$_GET["pro"]."&s_part=".$_GET["s_part"].'&s_part_a='.$_GET["s_part_a"]);
                                    ?>
									<br/>
                              </div>
						  </div>
