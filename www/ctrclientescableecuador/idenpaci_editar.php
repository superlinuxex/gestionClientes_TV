...
<a href=\customerscabletv\histoclie.php?id='.$registro['Codigo'].'>VER REGISTRO HISTORICO DEL CLIENTE</a>
									...
									<td>Sexo:</td>
										...
										<option value="3" '.($registro['Msexo']==3?' selected="selected" ':'').'>Persona Moral</option>											
										</select>
										</td>
									...
									<td><input type="hidden" class="frm_txt" name="SubPartidas_b" value="'.$registro['SubPartidas_b'].'" /></td>
									...
									<td>Dirección:</td>
									<td>
									<textarea name="Motraref" rows="5" cols="50">'.$registro['Motraref'].'</textarea>
									</td>
									...
									<td>Referencias:</td>
									<td>
									<textarea name="Mcalle" rows="5" cols="50">'.$registro['Mcalle'].'</textarea>
									</td>
									...
									<tr>
									<td>Pidio Desconexion Anticipada:</td>
									<td>
										<select name="Mpidiod" class="frm_cmb">
										<option value="1" '.($registro['Mpidiod']==1?' selected="selected" ':'').'>No</option>											
										<option value="2" '.($registro['Mpidiod']==2?' selected="selected" ':'').'>Si</option>											
										</select>
									</td>
									</tr>
									...
									<tr>
									<td>Mes pendiente de pago:</td>
									<td><input type="text" class="frm_txt" readonly="readonly" name="Limite" value="'.$registro['Limite'].'" /></td>
									</tr>
									...
									<td><input type="text" class="frm_txt" name="Mcadic" value="'.$registro['Cargoadic'].'" /></td>
									</tr>
									...
									<td><input type="text" class="frm_txt_long" name="Mobservacion" value="'.$registro['Mobservacion'].'"/></td>
											...
											<input  type="submit" value="Eliminar" class="frm_btn" name="eliminar"/>
							...
							case 'post':
										...
										//require_once("logica/log_idenpaci.php");
										//$resultado=log_direcciondupli_idenpaci2($_POST["Codigo2"],$_POST["Partida"],$_POST["SubPartidas"],$_POST["SubPartidas_a"],$_POST["SubPartidas_b"],$_POST["SubPartidas_c"],$_POST["Mcalle"],$_POST["Mave"],$_POST["Mpasaje"],$_POST["Mpoligono"],$_POST["Mcasa"],$_POST["Mblocke"]);
                 								//IF($resultado!=0){
									...
									<td><input type="hidden" class="frm_txt" name="SubPartidas_b" value="'.(isset($_POST['SubPartidas_b'])?$_POST['SubPartidas_b']:'').'" /></td>
									...
									<td><input type="hidden" class="frm_txt" name="Mcod_vende" value="'.(isset($_POST['Mcod_vende'])?$_POST['Mcod_vende']:'').'" /></td>
									...
									<td>
										<select name="Mttfactura" class="frm_cmb">
											<option value="2" '.(isset($_POST['Mttfactura'])?($_POST['Mttfactura']==2?' selected="selected" ':''):'').'>Factura</option>
										</select>
									</td>
									...
									<td><input type="hidden" readonly="readonly" class="frm_txt_long" name="Mgeo" value="'.(isset($_POST['Mgeo'])?$_POST['Mgeo']:'').'" /></td>
									<td><input type="hidden" class="frm_txt" readonly="readonly" name="Caduca" value="'.$diferencia.'" /></td>
									<td>Conexiones Extra:</td>
									...
									<td><input type="hidden" readonly="readonly" class="frm_txt" name="Mmarcha" value="'.(isset($_POST['Mmarcha'])?$_POST['Mmarcha']:'').'" /></td>
									<td><input type="hidden" readonly="readonly" class="frm_txt" name="Mposte" value="'.(isset($_POST['Mposte'])?$_POST['Mposte']:'').'" /></td>
