...
<title>Customerscabletv- Editar rango de numeros de facturas correlativos a utilizar</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Editar rango de numeros de facturas correlativos a utilizar</a></h3>
							<div class="entry">
								<?php
									$bodx=$_SESSION["idBodega"];
									require_once("logica/log_talonariocf.php");
									$tabla=log_obtener_talonariocf2($_GET["id"],$_GET["id1"],$_GET["id2"]);
									...
									else
									{
										...
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=talonariocf.php">';    
											exit;  
										}
										else
										{
									...
									echo '<form method="POST" id="id-form" action="'.$_SERVER["PHP_SELF"].'?id='.$_GET["id"].'"&id1='.$_GET["id1"].'"&id2='.$_GET["id2"].'" >';
							...
							case 'post':
										...
										if (($_POST['Mfacini'])>($_POST['Mfacfin']))
										{
											...
											if ($insertar==true)
											{
												$resultado=log_actualizar_talonariocf($_POST);
