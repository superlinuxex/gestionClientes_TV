...
<title>CRTCLIENTESCABLE- Editar actividad tecnica programada </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Editar Registro de actividad tecnica programada</a></h3>
							<div class="entry">
								<?php
								...
								if (intval(substr($registro['Fechaeje'],5,2))!=0)
								{
									...
									<td><input type="text" class="frm_txt" id="Fecha" readonly="readonly" name="Fecha" value="'.$registro['Fecha'].'"/></td>
									</tr>
								...
								if (intval(substr($registro['Fechaeje'],5,2))!=0)
								{
									...
									$insertar=false;
										...
										if (isset($_POST['Tecnico'])==false or $_POST['Tecnico']=="")
										{
											...
											if ($insertar==true)
											{
												$resultado=log_actualizar_actitecni($_POST,$_GET['id'],$bodx);
									...
									<tr>
									<td>Informacion adicional:</td>
									<td><input type="text" class="frm_txt_long" readonly="readonly" name="Comentario" value="'.(isset($_POST['Comentario'])?$_POST['Comentario']:'').'" /></td>
									</tr>
