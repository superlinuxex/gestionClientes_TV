...
<title>S I C I O - Eliminar Sub-Partida "B"</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h2 class="title">Eliminar Sub-Partida 'B'</a></h2>
							<div class="entry">
								<?php
									...
									{
										echo '<META HTTP-EQUIV="Refresh" Content="0; URL=subpartidas_a.php?part='.$_GET["part"].'&div='.$_GET["div"].'&pro='.$_GET["pro"].'&s_part='.$_GET["s_part"].'&s_part_a='.$_GET["s_part_a"].'&s_part_b='.$_GET["s_part_b"].'">';   
										exit;    
									}
									if (isset ($_POST['aceptar']))
									{
										
										$resulatado=log_eliminar_subpartida_b($_GET["part"],$_GET["div"],$_GET["pro"],$_GET["s_part"],$_GET["s_part_a"],$_GET["s_part_b"]);
