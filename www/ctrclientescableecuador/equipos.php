...
<title>S I C I O - Mantenimiento de Equipos </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h2 class="title">Catálogo de Equipos</a></h2>
							<div class="entry">
								...
								<div id="itsthetable">
                                	<?php
										...
										$total_registros=log_obtener_num_equipos();
										...
										$usuarios=log_obtener_equipos($comienzo,$_SESSION["cant_reg_pag"]);
										$campos = array("Codigo","Nombre");
										crear_tabla($usuarios, $campos,'equipos','equipos.php',false,"equipos_editar.php",
													"equipos_eliminar.php","equipos_detalle.php","equipos_agregar.php");
										echo "<div style=\"padding:15px;\" align=\"center\">";
										paginacion ($num_pag,$total_registros,"equipos.php?pagina=");
										echo"</div>";
                                    ?>
                              </div>
						  </div>
