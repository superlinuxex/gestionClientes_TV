...
<body>
	...
	<div style="position:absolute;top:15px;border:1px no-solid;width:100%;height:98%;">
		...
		<div style="position:absolute;left:850px;top:10px;width:350px;height:22px;z-index:1;">
			<span style="color:#000000;font-family:Arial;font-size:18px;"><strong>Fecha: </strong>'.date('d/m/Y').'</span>
		</div>


		<div style="position:absolute;left:10px;top:100px;width:350px;height:22px;z-index:1;">
			<span style="color:#000000;font-family:Arial;font-size:18px;"><strong>Sucursal: </strong>'.$nom_bodega.'</span>
		</div>
		...
		<table cellspacing="0" class="Tabla1" style="position:absolute;left:1px;top:130px;width:98%;">
			<tr>
			<td class="FilaNI" style="height: 22px; font-size:18px"><strong>Codigo</strong></td>
				<td class="FilaN" style="height: 22px; font-size:18px"><strong>Nombre</strong></td>
				<td class="FilaN" style="height: 22px; font-size:18px"><strong>Municipio</strong></td>
				<td class="FilaN" style="height: 22px; font-size:18px"><strong>Poblacion</strong></td>
				<td class="FilaN" style="height: 22px; font-size:18px"><strong>Sector</strong></td>
				<td class="FilaN" style="height: 22px; font-size:18px"><strong>Caja</strong></td>
				<td class="FilaN" style="height: 22px; font-size:18px"><strong>Direccion</strong></td>
				<td class="FilaNF" style="height: 22px; font-size:18px;text-align: center;padding-right:0px;"><strong>Referencias</strong></td>
			</tr>';	
                        $cuentafila=1;
                        $sumalineas=0;
    ...
    $caja=$filaz['poligono'];
			        ...
			        $content .= ' 
					<tr>
						<td class="FilaNI" style="height: 22px;font-size:18px; text-align: center">'.$cliente.'</td>
						<td class="FilaN" style="height: 22px; font-size:18px; text-align: left">'.$ncliente.'</td>
						<td class="FilaN" style="height: 22px; font-size:18px; text-align: center">'.$municipio.'</td>
						<td class="FilaN" style="height: 22px; font-size:18px; text-align: center">'.$poblacion.'</td>
						<td class="FilaN" style="height: 22px; font-size:18px; text-align: center">'.$sector.'</td>
						<td class="FilaN" style="height: 22px; font-size:18px; text-align: center">'.$caja.'</td>
						<td class="FilaN" style="height: 22px; font-size:18px; text-align: center">'.$direccion.'</td>
						<td class="FilaNF" style="height: 22px;font-size:18px; text-align:center">'.$referencia.'</td>
					</tr>';	
			...
			<td class="FilaN2" style="height: 22px; font-size:12px; text-align: center"></td>
			<td class="FilaN2" style="height: 22px; font-size:12px; text-align: center"></td>
			<td class="FilaNF2" style="height: 22px;font-size:18px; text-align: center">Total: '.$sumatotalgen.'</td>
			</tr>';	
			echo'
		</table>
	</div>
...
$pdf->lastPage();
$pdf->output('pdfRep_listaclientes.pdf', 'I');
