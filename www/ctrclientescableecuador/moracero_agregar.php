		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				...
				$registro=mysql_fetch_array($resultado);
			        ...
			        echo 'Importante: Usted va a reiniciar la cuenta del cliente:&nbsp;'.$clie." ".$nombreclie." ";
                                echo 'con un nuevo contrato, se creará en forma automatica un nuevo codigo para la nueva cuenta y se cerrará la cuenta con el codigo que tiene actualmente. Debe solicitar la reconexion (concepto RENOVACION.... en actividades tecnicas) para el nuevo codigo y activarlo desde la seccion de actividades tecnicas';
									...
									<tr>
									<td><h3 class="title">DATOS DE APERTURA</a></h3></td>
									</tr>
