...
<title>Customerscabletv - Editar promosiones en los planes</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Editar promociones para planes</a></h3>
							<div class="entry">
								<?php
									require_once("logica/log_promocion.php");
									$tabla=log_obtener_promocion($_GET["id"]);
									...
									else
									{
										...
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=promocion.php">';    
											exit;  
										}
										else
										{
									...
									switch ($mostrar_datos)
									{
										...
										case 'post':
											...
											if ($insertar==true)
											{
												$resultado=log_actualizar_promocion($_POST,$_GET['id']);
