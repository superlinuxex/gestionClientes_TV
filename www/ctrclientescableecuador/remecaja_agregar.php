...
<title>Customerscabletv - Agregar cheques emitidos </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Agregar un pago</a></h3>
							<div class="entry">
								<?php
									...
									if (isset ($_POST['aceptar']))
									{
										...
										{
											echo '<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#ce2700;">
											Debe ingresar a nombre de quien esta el chueque
											</div>';
											$insertar=false;
										}
										...
										if ($insertar==true)
										{
											$resultado=log_insertar_remecaja($_POST);
                 									IF($resultado==1){
									...
									<td><input type="text" class="frm_txt_long" name="Responsable" value="'.(isset($_POST['Responsable'])?$_POST['Responsable']:'').'" /></td>
									...
									<td><input type="text" class="frm_txt" hidden="true" name="Sucursal" value="'.(isset($_POST['Sucursal'])?$_POST['Sucursal']:'').'" /></td>
