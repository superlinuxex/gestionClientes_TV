...
<title>Customerscabletv - Agregar Detalle de Entrada de articulos </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Agregar Detalle de la compra de Articulos</a></h3>
							<div class="entry">
								<?php
									$marc1="SINMARCA";
									...
									if ($Encabezado['1']==1)
									{
										...
										if ($Encabezado['7']!="")
										{
											echo '&nbsp;&nbsp;Comprobante de credito fiscal No.:&nbsp;'.$Encabezado['7'];
											echo '&nbsp; de Fecha:&nbsp;'.$Encabezado['13'];
									...
									if ($Encabezado['1']==2)
									{
										...
										if ($Encabezado['8']!="")
										{
											echo '&nbsp;&nbsp;Factura de consumidor final No.:&nbsp;'.$Encabezado['8'];
											echo '&nbsp; de Fecha:&nbsp;'.$Encabezado['13'];
									...
									if (isset ($_POST['aceptar']))
									{
										if (isset($_POST['Producto'])==false or $_POST['Producto']=="")
										{
											...
											Debe seleccionar un Producto para el Detalle de Entrada.
											</div>';
											$insertar=false;
										}
										...
										{
											echo '<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#ce2700;">
											Debe ingresar la cantidad para el Detalle de Entrada.
											</div>';
											$insertar=false;										
										}
										else
										...
										if (isset($_POST['Precio'])==false or $_POST['Precio']=="" or $_POST['Precio']==0)
										{
											echo '<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#ce2700;">
											Debe ingresar el precio Unitario para el Detalle de Entrada.
											</div>';
											$insertar=false;										
										}
										...
										if ($insertar==true)
										{
											...
											if (log_validar_entrada($codigo_entrada)==0)
											{
												log_insertar_entrada($Encabezado);
											}
											$resulatado=log_insertar_entrada_detalle($_POST,$bodega,$Encabezado);
											$resulatado=log_insertar_existencia($_POST,$bodega,$_POST['Producto'],$_POST['Cantidad'],$_POST['CodEntrada'],$_POST['Precio'],$_POST['Estado'],$Encabezado);
									...
									while ( $fila = mysql_fetch_array($resultado))
									{
									 if (isset($_POST["Producto"]))
									  ...
									  {
									  echo "<option value='".$fila['Codigo']."'> ".$fila['Nombre']." -- Comprado por ".$fila['Medida']."</option>";
									  }
									 }
									 echo'
									 </td>									
									...
									<tr>
									<td>Cantidad de artículos según documento de compra:</td>
									<td><input type="text" class="frm_txt" name="Cantidad" value="'.(isset($_POST['Cantidad'])?$_POST['Cantidad']:'').'" /></td>
									</tr>
									
									<tr>
									<td>Precio unitario según documento de compra:</td>
									<td><input type="text" class="frm_txt" name="Precio" value="'.(isset($_POST['Precio'])?$_POST['Precio']:'').'" /></td>
									</tr>
