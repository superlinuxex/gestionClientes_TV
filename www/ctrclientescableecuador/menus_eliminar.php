		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Eliminar Menú del Sistema</a></h3>
							<div class="entry">
								<?php
									...
									if (isset ($_POST['aceptar']))
									{
										...
										$resulatado=log_eliminar_menu($_GET["id"]);
									...
									if ($mostrar_datos==true)
									{
										...
										<tr>
										<td>Texto:</td>
										<td><input type="text" readonly="readonly" class="frm_txt" name="Texto" value="'.$registro['Texto'].'" /></td>
										</tr>
										<tr>

										<tr>
										<td>Url:</td>
										<td><input type="text" readonly="readonly" class="frm_txt" name="Url" value="'.$registro['Url'].'" /></td>
										</tr>
										<tr>

										<tr>
										<td>Nivel:</td>
										<td><input type="text" readonly="readonly" class="frm_txt" name="Nivel" value="'.$registro['Nivel'].'" /></td>
										</tr>
										<tr>
										
										<tr>
										<td>Columna:</td>
										<td><input type="text" readonly="readonly" class="frm_txt" name="Columna" value="'.$registro['Columna'].'" /></td>
										</tr>
										<tr>
