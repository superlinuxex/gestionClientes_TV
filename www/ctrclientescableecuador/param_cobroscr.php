...
<title>SICCAE - Reporte de a visos de cobros</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title"><a href="#">Parametros para la Generacion del Reporte avisos de cobro de clientes credito fiscal</a></h3>
							<div class="entry">
								<?php
									...
									if (isset ($_POST['aceptar']))
									{
										...
										if (isset($_POST['Mvendedor'])==false or $_POST['Mvendedor']=="")
										{
											echo '<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#ffffff;">
											Debe indicar quien es el cobrador asignado
											</div>';
											$insertar=false;
										}
										...
										if ($insertar==true)
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=rpt_avisoscr.php?
