...
<title>CTRCLIENTESCABLE- Reprogramar actividad tecnica</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Reprogramar actividad tecnica</a></h3>
							<div class="entry">
								<?php
								...
								if (intval(substr($registro['Fechaeje'],5,2))!=0)
								{
									...
									Imposible modificar datos, esta actividad ya fue ejecutada
									</div>';
								}
									...
									<tr>
									<td>Fecha a reprogramar la tarea:</td>
									<td><input type="text" class="frm_txt" id="Fecharepro" name="Fecharepro" value="'.$registro['Fecharepro'].'"/></td>
									</tr>
							...
							case 'post':
								if (intval(substr($registro['Fechaeje'],5,2))!=0)
								{
									...
									$insertar=false;
											...
											if ($insertar==true)
											{
												$resultado=log_reprogramar_actitecni($_POST,$_GET['id'],$bodx);
									...
									<tr>
									<td>Fecha a reprogramar la tarea:</td>
									<td><input type="text" class="frm_txt" id="Fecharepro" name="Fecharepro" value="'.(isset($_POST['Fecharepro'])?$_POST['Fecharepro']:'').'"/></td>
									</tr>
