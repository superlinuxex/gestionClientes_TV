...
<title>Customerscabletv - Reporte de clientes conectados a la fecha</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title"><a href="#">Parametros para la Generacion del Reporte clientes con estatus de conexion</a></h3>
							<div class="entry">
								<?php
									...
									<td>
										<select name="Tipoinfo" class="frm_cmb_long">
											<option value="1" '.(isset($_POST['Tipoinfo'])?($_POST['Tipoinfo']==1?' selected="selected" ':''):'').'>Clientes Conectados</option>
											<option value="2" '.(isset($_POST['Tipoinfo'])?($_POST['Tipoinfo']==2?' selected="selected" ':''):'').'>Clientes Desconectados</option>
										</select>
									</td>
									</tr>
									...
									<td>
									<select name="Servicio" class="frm_cmb" />
									...
									<tr>
									<td>Motivo desconexion(para desconectados):</td>
									<td>
