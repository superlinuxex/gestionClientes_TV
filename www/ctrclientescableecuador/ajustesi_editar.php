...
<title>Customerscabletv- Editar ajustes de inventarios</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Editar Registro de ajuste</a></h3>
							<div class="entry">
								<?php
									...
									case 'get':
										...
										<tr>
										<td>Concepto:</td>
										<td><input type="text" class="frm_txt_long" name="Concepto" value="'.$registro['Concepto'].'" /></td>
										</tr>
								...
								case 'post':
									if ($insertar==true)
 									{
 									 $resultado=log_actualizar_ajustesi($_POST,$_GET['id'],$bodx,$registro);
									...
									if ($insertar==false)
									 ...
									 <tr>
									 <td>Descripcion del artículo:</td>
									 <td><input type="text" class="frm_txt" readonly="readonly" name="Descripcion" value="'.(isset($_POST['Descripcion'])?$_POST['Descripcion']:'').'" /></td>
									 </tr>
