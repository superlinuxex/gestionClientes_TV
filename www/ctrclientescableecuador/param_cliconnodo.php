...
<title>Customerscabletv - Reporte de clientes desconectados y con nodo instalado</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title"><a href="#">Parametros para Reporte clientes desconectado y aun con nodo</a></h3>
							<div class="entry">
								<?php
									if (isset ($_POST['aceptar']))
									{
										...
										if ($insertar==true)
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=rpt_clidescomnodo.php?

											fd='.(isset($_POST['Nmeses'])?$_POST['Nmeses']:'').'
											&ti='.(isset($_POST['Nsector'])?$_POST['Nsector']:'').'
									...
									<tr>
									<td>Mes de desconexion:</td>
									<input type="text"  name="Nmeses"  class="frm_txt" value="'.(isset($_POST['Nmeses'])?$_POST['Nmeses']:'').'">
									</td>
									</tr>

									<tr>
									<td>Sector:</td>
									<input type="text"  name="Nsector"  class="frm_txt" value="'.(isset($_POST['Nsector'])?$_POST['Nsector']:'').'">
									</td>
									</tr>
