...
if($_GET['ti']==3)
 {
   //Clientes de facturas de recibos
	...
	while ( $filaz = mysql_fetch_array($resultado))
	 {
 	  $cliente=$filaz['cod_cliente'];
          ...
          //Filtar: Mes de fecha2 del ultimo periodo de pago del cliente debe ser menor o igual al mes de la fecha actual, o si el año de fecha actual es mayor al año de la fecha 2 del periodo.
...
<title>CUSTOMERSCABLETV - Lista de clientes que seben por el servicio mensual hasta la fecha</title>
</head>
<body>
	<div style="position:absolute;top:15px;border:1px no-solid;width:100%;height:98%;">
		...
		<table cellspacing="0" class="Tabla1" style="position:absolute;left:1px;top:130px;width:98%;">
			...
			<span style="color:#000000;font-family:Arial;font-size:25px;"><strong>Lista de clientes con pago pendiente - Fecha de informe:</strong>'.date('d/m/Y').'</span>
			</div>
    ...
    <td style="position:absolute;left:550px;top:'.$cuentalin.'px;width:400px;height:37px;font-size:20px">DEBE DESDE: '.$ttfecha1.' A: '.$ttfecha2.'</td>
    <td style="position:absolute;left:920px;top:'.$cuentalin.'px;width:200px;height:37px;font-size:20px;text-align:left">'.$xmonto.'</td>
    </tr>';
    ...
    <td style="position:absolute;left:650px;top:'.$cuentalin.'px;width:200px;height:37px;font-size:18px">Meses pendientes:'.$xmesespen.'</td>
    <td style="position:absolute;left:860px;top:'.$cuentalin.'px;width:200px;height:37px;font-size:18px">Total a pagar:'.$xapagar.'</td>
    </tr>';
    $cuentalin=$cuentalin+30;
    echo '
    <tr>
