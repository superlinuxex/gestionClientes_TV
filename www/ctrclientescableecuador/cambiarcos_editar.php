...
<title>Customerscabletv- Mantenimiento de costos </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h2 class="title">Costo del articulo</a></h2>
							<div class="entry">
								<?php
									...
									else
									{
										...
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=cambiarcos.php">';    
											exit;  
										}
										else
										{
									...
									case 'get':
									 ...
									 <tr>
									 <td>Costo en nuevo:</td>
									 <td><input type="text" class="frm_txt" name="Coston" value="'.$registro['Coston'].'" /></td>
									 </tr>

									 <tr>
									 <td>Costo en usado:</td>
									...
									if ($insertar==true)
 									 {
									  $resulatado=log_actualizar_kardex($_POST,$_GET["id"],$bodx);
									 ...
									 if ($insertar==false)
									   {
											...
											<tr>
											<td>Costo en nuevo:</td>
											<td><input type="text" class="frm_txt" name="Coston" value="'.(isset($_POST['Coston'])?$_POST['Coston']:'').'" /></td>
											</tr>
