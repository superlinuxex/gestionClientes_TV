...
<title>Customerscabletv - Editar remesas de caja chica </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Editar remesa</a></h3>
							<div class="entry">
								<?php
						...
						case 'post':
										...
										{
											echo '<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#ffffff;">
											Debe ingresar la sucursal destino de la remesa
											</div>';
											$insertar=false;
										}
											...
											if ($insertar==true)
											{
												$resultado=log_actualizar_remecaja($_POST,$_GET['id']);
