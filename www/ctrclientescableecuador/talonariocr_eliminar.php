...
<title>Customerscabletv- Eliminar rango de numeros de comprobantes fiscales a utilizar</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Eliminar rango de numeros de comprobantes fiscales a utilizar</a></h3>
							<div class="entry">
								<?php
									...
									if (isset ($_POST['aceptar']))
									{
										...
										$resulatado=log_eliminar_talonariocr($_POST);
