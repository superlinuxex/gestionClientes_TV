...
<title>Customerscabletv - Agregar velocidades de conexion</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Agregar velocidades de conexion</a></h3>
							<div class="entry">
								<?php
									...
									if (isset ($_POST['aceptar']))
									{
										...
										if ($insertar==true)
										{
											$resultado=log_insertar_veloconec($_POST);
                 									IF($resultado==1){
