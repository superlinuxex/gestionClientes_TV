...
<title>Customerscabletv - Eliminar Color </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Eliminar color o tipo de material</a></h3>
							<div class="entry">
								<?php
									...
									if (isset ($_POST['aceptar']))
									{
										...
										$resulatado=log_eliminar_color($_GET["id"]);
										if ($resulatado==1)
										{
										...
										{	
											if ($resulatado=='1451')
											{
												...
												No se puede eliminar este color pues ya tiene movimientos.
												</div>';
											}
											else
											{
