...
<title>Customerscabletv- Editar planes base</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Editar planes base</a></h3>
							<div class="entry">
								<?php
									require_once("logica/log_planbase.php");
									$tabla=log_obtener_planbase($_GET["id"]);
									...
									else
									{
										...
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=planbase.php">';    
											exit;  
										}
										else
										{
									...
									switch ($mostrar_datos)
									{
										...
										case 'post':
											...
											if ($insertar==true)
											{
												$resultado=log_actualizar_planbase($_POST,$_GET['id']);
