		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Eliminar Artículo del Detalle de la compra</a></h3>
							<div class="entry">
								<?php
									...
									{										
										$resultado=log_eliminar_entrada_detalle($codigo_entrada,$_GET['id'],$registro["Cantidad"],$bodega,$registro["Producto"],$registro["Estado"]);
									...
									if ($mostrar_datos==true)
									{
										...
										<tr>
										<td>Unidad de Medida de compra:</td>
										...
										<td><input type="text" class="frm_txt" readonly="readonly" name="Precio" value="'.$registro["Precio"].'" /></td>
										</tr>
