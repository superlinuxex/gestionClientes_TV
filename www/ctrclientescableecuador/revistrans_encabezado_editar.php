...
<title>Customerscabletv - Editar Encabezado de Transferencias </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Actualizacion de existencias por transferencia recibida</a></h3>
							<div class="entry">
								<?php
									...
									else
									{
										...
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=revistrans.php">';    
											exit;  
										}
										else
										{
										...
										case 'get':
											...
											switch ($tipo)
											{
												case '1':
													...
													while ( $fila = mysql_fetch_array($resultado))
													{
														if ($fila['Codigo']==$registro['Codigoempl2'])
														{
															echo '<option value="'.$fila['Codigo'].'" selected="selected">'.$fila['Nombre'].'</option>';
														}
														else
												...
												<tr>
												<td>Fecha de recibo de la transferencia:</td>
												<td><input type="text" class="frm_txt"  id="Fechat" name="Fechat" value="'.$registro['Fechat'].'"/></td>
												</tr>

									
												<tr>
												<td>Observaciones al recibir la transferencia:</td>
												<td><input type="text" class="frm_txt_long" name="Observacionest" value="'.$registro['Observacionest'].'" /></td>
												</tr>';
												break;
												default:
												break;
											...
											<input  type="submit" value="Cargar Inventario"  class="frm_btn" name="aceptar"/>
										...
										case 'post':
											...
											if (isset($_POST['Fechat'])==false or $_POST['Fechat']=="")
											{
												...
												$Actualizar=false;
													...
													if ($Actualizar==true)
													{
														$resultado=log_actualizar_revistrans($_POST,$tipo,$registro);
														if($resultado==1)
														 {
														  echo'<div style="background:url(imagenes/msg_green.png) no-repeat; padding:10px 10px 10px 10px; Color:#6da827;">
														  Se ha transferido los materiales a su inventario correctamente.
														  </div>';
														 }
														  else
														 {
														  echo'<div style="background:url(imagenes/msg_green.png) no-repeat; padding:10px 10px 10px 10px; Color:#6da827;">
														  La transferencia ya se habia recibido, imposible recibir dos veces.
														  </div>';
														 }
												...
												<tr>
												<td>Fecha de recibo de transferencia:</td>
