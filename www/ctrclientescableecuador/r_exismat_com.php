<?php
 include "./utils/validar_sesion.php";
	...
	$resultado=log_obtener_existenciasc2($_SESSION["idBodega"]);
	$resultado2=log_obtener_existenciasc2($_SESSION["idBodega"]);
...
<title>S I C I O - Reporte de Existencias de Combustibles</title>
</head>
<body>
	<div style="position:absolute;left:15%;top:15px;border:1px solid black;width:820px;height:95%;">
		...
		<div style="position:absolute;left:40px;top:50px;width:800px;height:37px;text-align:center;z-index:0;">
			<span style="color:#000000;font-family:Arial;font-size:32px;"><strong>Reporte de Existencia de Combustibles</strong></span>
		</div>
		...
		<table cellspacing="0" class="Tabla1" style="position:absolute;left:10px;top:130px;width:800px;">
			<tr>
				<td class="FilaNI" style="height: 22px"><strong>Codigo Combustible</strong></td>
