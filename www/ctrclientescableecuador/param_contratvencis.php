...
<title>Customerscabletv - Reporte de contratos vencidos o a vencer</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Parametros para la Generacion contratos vencidos o a vencer</h3>
							<div class="entry">
								<?php
									if (isset ($_POST['aceptar']))
									{
										...
										if ($insertar==true)
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=rpt_contratvenci.php?
									...
									<td>
										...
										$resultado=log_obtener_bodegas_cmb3($_SESSION["idBodega"]);
