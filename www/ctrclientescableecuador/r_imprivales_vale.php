<?php
    ...
    $resultado=log_obtener_mov_salidas_vale($_GET['numerovale'],$_GET['proy'],$_GET['bod']);
...
<div style="position:absolute;left:1x;top:'.$cuentalin.'px;border:1px solid ;width:535px;height:450px;">
    <tr>
    <td style="position:absolute;left:5px;top:'.$cuentalin.'px;width:200px;height:45px;background-image:url(\'imagenes/arco_log_rpt.png\');"></td>
    </tr>';
