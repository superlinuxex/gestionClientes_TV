...
<title>Customerscabletv - Reporte de clientes desconectados con mora</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title"><a href="#">Parametros para Reporte clientes con mora</a></h3>
							<div class="entry">
								<?php
									if (isset ($_POST['aceptar']))
									{
										...
										if ($insertar==true)
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=rpt_debenpormes.php?

											fd='.(isset($_POST['Nmeses'])?$_POST['Nmeses']:'').'
									...
									<td>
										<select name="Tipoinfo" class="frm_cmb_long">
											<option value="1" '.(isset($_POST['Tipoinfo'])?($_POST['Tipoinfo']==1?' selected="selected" ':''):'').'>Clientes conectados y con mora de uno o mas meses</option>
										</select>
									</td>
									</tr>

									<tr>
									<td>Numero de meses de mora a filtrar:</td>
									<td>
										<select name="Nmeses" class="frm_txt">
											<option value="1" '.(isset($_POST['Nmeses'])?($_POST['Nmeses']==1?' selected="selected" ':''):'').'>1</option>
											<option value="2" '.(isset($_POST['Nmeses'])?($_POST['Nmeses']==2?' selected="selected" ':''):'').'>2</option>
											<option value="3" '.(isset($_POST['Nmeses'])?($_POST['Nmeses']==3?' selected="selected" ':''):'').'>3</option>
											<option value="4" '.(isset($_POST['Nmeses'])?($_POST['Nmeses']==4?' selected="selected" ':''):'').'>4</option>
											<option value="5" '.(isset($_POST['Nmeses'])?($_POST['Nmeses']==5?' selected="selected" ':''):'').'>5</option>
										</select>
									</td>
									</tr>
