<?php
	...
	$resultado=log_obtener_ventas_deta_cr($_GET['fd'],$_GET['fh'],$_GET['bod']);
...
<title>SICCAE - Reporte de ventas en credito fiscal</title>
</head>
<body>
	<div style="position:absolute;top:15px;border:1px no-solid;width:100%;height:98%;">
		...
		<div style="position:absolute;left:100px;top:50px;width:800px;height:37px;text-align:center;z-index:0;">
			<span style="color:#000000;font-family:Arial;font-size:32px;"><strong>Ventas con credito fiscal</strong></span>
		</div>
		...
		<table cellspacing="0" class="Tabla1" style="position:absolute;left:1px;top:130px;width:98%;">
			<tr>
				...
				<td class="FilaN" style="height: 22px"><strong>Anulada</strong></td>
			...
			while ( $fila = mysql_fetch_array($resultado))
			{
				...
				if(mysql_num_rows ( $resultado2 )!=0)
				  {
					...
					<tr>
						...
						<td class="FilaN" style="height: 22px; font-size:10px; text-align: center">'.$xanulada.'</td>
				...
				<td class="FilaN2" style="height: 22px"><strong>Anulada</strong></td>
