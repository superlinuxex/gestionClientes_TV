...
<body>
	<div style="position:absolute;top:15px;border:1px no-solid;width:100%;height:98%;">
		...
		<div style="position:absolute;left:400px;top:50px;width:350px;height:22px;z-index:1;">
			<span style="color:#000000;font-family:Arial;font-size:12px;"><strong>Nombre: </strong>'.$nomusu.'<strong>&nbspApellido: </strong>'.$apeusu.'</span>
		</div>
		...
		<tr>
				<td class="FilaNI" style="height: 22px;width:50px"><strong>No.</strong></td>
				...
				<td class="FilaN" style="height: 22px"><strong>Cajero</strong></td>
        ...
        require_once("logica/log_usuarios.php");
        $datosusuario=log_obtener_usuario($fila['idusuarios']);
	$datou3=mysql_fetch_array($datosusuario);
        $nomusu=$datou3['Nombre'];
        $apeusu=$datou3['Apellido'];
        $cajero=$nomusu.' '.$apeusu;
				...
				//  }
			        ...
			        echo '
					<tr>
						<td class="FilaNI" style="height: 22px; font-size:10px; text-align: center">'.$cuentafila.'</td>
						<td class="FilaN" style="height: 22px; font-size:10px; text-align: center">'.$fila['cod_cliente'].'</td>
						<td class="FilaN" style="height: 22px; font-size:10px; text-align: center">'.$xncliente.'</td>
						<td class="FilaN" style="height: 22px; font-size:10px; text-align: center">'.$cajero.'</td>
				...
				<td class="FilaN2" style="height: 22px"><strong>Cajero</strong></td>
