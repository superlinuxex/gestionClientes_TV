...
<title>Customerscabletv - Editar Color </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Editar color o tipo de material</a></h3>
							<div class="entry">
								<?php
									require_once("logica/log_color.php");
									$tabla=log_obtener_color2($_GET["id"]);
									...
									else
									{
										...
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=colores.php">';    
											exit;  
										}
										else
										{
									...
									switch ($mostrar_datos)
									{
										...
										case 'post':
											if (isset($_POST['Codigo'])==false or $_POST['Codigo']=="")
											{
												...
												Debe ingresar el Codigo para el color que desea ingresar
												</div>';
												$insertar=false;
											}
											...
											{
												echo '<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#ce2700;">
												Debe ingresar el Nombre para el color que desea ingresar
												</div>';
												$insertar=false;
											}
											...
											if ($insertar==true)
											{
												$resultado=log_actualizar_color($_POST,$_GET['id']);
