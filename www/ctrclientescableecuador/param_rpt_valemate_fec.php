						...
						<div class="post">
							 ...
							 switch ($tipo)
							 {
							  ...
							  if (isset ($_POST['aceptar']))
								...
								if (isset($_POST['Fecha'])==false or $_POST['Fecha']=="")
								{
									...
									Debe ingresar la Fecha de la cual se mostraran los movimientos.
									</div>';
									$insertar=false;
								}
								if ($insertar==true)
				 				 {
									...
									echo '<META HTTP-EQUIV="Refresh" Content="0; URL=r_imprivales.php?
							...
							while ( $fila = mysql_fetch_array($resultado))
								...
								echo'
												...
												<tr>
												<td><input type="text" hidden="true" class="frm_txt_long" name="tipo" value="'.(isset($_POST['tipo'])?$_POST['tipo']:'').'" /></td>
												</tr>
							...
							case '2':/*un solo vale*/
									...
									if (isset ($_POST['Ingresar']))
									{
										...
										if ($insertar==true)
										{
											...
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=r_imprivales_vale.php?
											numerovale='.(isset($_POST['Nvale'])?$_POST['Nvale']:'').'
											&proy='.(isset($_POST['Proyecto'])?$_POST['Proyecto']:'').'
											&bod='.(isset($_POST['Bodega'])?$_POST['Bodega']:'').'
											&t1='.$t1.'&t2='.$t2.'">';
											exit;
									...
									<tr>
									<td colspan="2" align="center">
									<input  type="submit" value="Generar"  class="frm_btn" name="Ingresar"/>
									</td>
									</tr>
									</table>
									</form>';
											...
											default:
												echo '<META HTTP-EQUIV="Refresh" Content="0; URL=param_rpt_valemate.php">';
											break;
										}
