...
<title>Customerscabletv - Eliminar Sucursal</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Eliminar Sucursal</a></h3>
							<div class="entry">
								<?php
									...
									if (isset ($_POST['aceptar']))
									{
										...
										$resulatado=log_eliminar_bodega($_GET["id"]);
										if ($resulatado==1)
										{
										...
										{	
											if ($resulatado=='1451')
											{
												...
												No se puede eliminar esta bodega pues ya se ha asignado a un proyecto o ya tienen movimientos.
												</div>';
											}
											else
											{
									...
									if ($mostrar_datos==true)
									{
										...
										<td><input type="text" readonly="readonly" class="frm_txt" name="Empresa" value="'.$registro['Empresa'].'" /></td>
										</tr>
										<tr>
										...
										<tr>
										<td>Dirección:</td>
										<td><input type="text" readonly="readonly" class="frm_txt_long" name="Ubicacion" value="'.$registro['Ubicacion'].'" /></td>
										</tr>
										<tr>

										<tr>
 										<td>Nombre del responsable:</td>
										<td><input type="text" readonly="readonly" class="frm_txt_long" name="Usuario" value="'.$registro['Usuario'].'" /></td>
										</tr>
										<tr>
