		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Editar Perfil de usuario del Sistema</a></h3>
							<div class="entry">
								<?php
								require_once("logica/log_perfiles.php");
									$tabla=log_obtener_perfil($_GET["id"]);
									...
									else
									{
										...
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=perfiles.php">';    
											exit;  
										}
										else
										{
									...
									switch ($mostrar_datos)
									{
										...
										case 'post':
											if (isset($_POST['Nombre'])==false or $_POST['Nombre']=="")
											{
												...
												Debe ingresar el nombre para el perfil que desea ingresar
												</div>';
												$insertar=false;
											}
											...
											{
												echo '<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#ce2700;">
												Debe ingresar la descripcion para el perfil que desea ingresar
												</div>';
												$insertar=false;
											}
											...
											if ($insertar==true)
											{
												$resultado=log_actualizar_perfil($_POST,$_GET['id']);
