		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Detalle factura por servicios</a></h3>
							<div class="entry">
								<div id="itsthetable">
								<?php
								$factura=$_SESSION['factura'];
								$tipo=$_SESSION['tipo'];
								$bodega=$_SESSION['sucursal'];
								...
								$idusuarios=$_SESSION['idusuarios'];
									...
									crear_tabla($articulos, $campos,'facturas_detalleanu','facturas_detalleanu.php',false,"facturas_detalle_editar.php",
									"facturas_detalle_eliminar.php","facturas_detalleanu.php","facturas_detalle_agregar.php?lafecha=$fecha1");
									echo "<div style=\"padding:15px;\" align=\"center\">";
									paginacion ($num_pag,$total_registros,"facturas_detalleanu.php?pagina=");
									echo"</div>";
								?>
				                              </div>
							  </div>
