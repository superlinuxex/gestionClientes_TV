...
<title>Customerscabletv - Eliminar actividad tecnica programada </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Eliminar Registro de programacion de actividad tecnica</a></h3>
							<div class="entry">
								<?php
								...
								if (intval(substr($registro['Fechaeje'],5,2))!=0)
								{
									...
									Imposible eliminar datos, esta actividad ya fue ejecutada
									</div>';
								}

									if (isset ($_POST['cancelar']))
									{
										echo '<META HTTP-EQUIV="Refresh" Content="0; URL=actitecni2.php">';    
										exit;    
									}
									if (isset ($_POST['aceptar']))
									{
										...
										if($eliminar=="true")
										{
										 $resulatado=log_eliminar_actitecni($_GET["id"],$bodx);
									...
									<td><input type="text" class="frm_txt_long" readonly="readonly" name="Detalles" value="'.$registro['Detalles'].'" /></td>
									</tr>
