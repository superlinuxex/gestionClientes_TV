...
<title>Customerscabletv - Mantenimiento de Barrios</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Agregar Barrio</a></h3>
							<div class="entry">
								<?php
									...
									if (isset ($_POST['cancelar']))
									{
										...
										URL=barrios.php?part='.$_GET["part"].'&s_part='.$_GET["s_part"].'&s_part_a='.$_GET["s_part_a"].'">';
										exit;    
									}
									if (isset ($_POST['aceptar']))
									{
										...
										if (isset($_POST['Codigo'])==false or $_POST['Codigo']=="")
										{
											...
											Debe ingresar el Codigo para el barrio que desea ingresar
											</div>';
											$insertar=false;
										}
										if ($insertar==true)
										{
											$barrio_existe = log_validar_existencia_barrio($_GET["part"],$_GET["s_part"],$_GET["s_part_a"],$_POST['Codigo']);
											if ($barrio_existe==true)
											{
												echo '<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#ce2700;">
												El codigo del Barrio ya existe 
												</div>';
												$insertar=false;
											}
										}
										...
										{
											echo '<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#ce2700;">
											Debe ingresar el Nombre para la localidad que desea ingresar
											</div>';
											$insertar=false;
										}
										if ($insertar==true)
										{
											$resulatado=log_insertar_barrio($_POST);
									...
									action="'.$_SERVER["PHP_SELF"].'?part='.$_GET["part"].'&s_part='.$_GET["s_part"].'&s_part_a='.$_GET["s_part_a"].'" >';
