		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Editar Usuarios del Sistema</a></h3>
							<div class="entry">
								<?php
									...
									else
									{
										...
										else
										{
										    if(isset($_POST['reiniciar']))
										    {
										     ...
										     $resultado=log_reiniciar_usuario($nclave,$_GET['id']);
										     echo'<div style="background:url(imagenes/msg_green.png) no-repeat; padding:10px 10px 10px 10px; Color:#6da827;">
										     La clave ha sido reiniciada.
										     </div>';
										    }
										    if(isset($_POST['desactivar']))
										    {
                                                                                     $nclave="a+s+_tt.ds.s";
										     require_once("logica/log_usuarios.php");
										     $resultado=log_desactivar_usuario($nclave,$_GET['id']);
										     echo'<div style="background:url(imagenes/msg_green.png) no-repeat; padding:10px 10px 10px 10px; Color:#6da827;">
										     El codigo el usuario ha sido desactivado.
										     </div>';
										    }
									...
									switch ($mostrar_datos)
									{
										case 'get':
											...
											<tr>
											<td>Apellido:</td>
											<td><input type="text" class="frm_txt" name="Apellido" value="'.$registro['Apellido'].'" /></td>
											</tr>
											<tr>

											<tr>
											<td>Usuario:</td>
											<td><input type="text" class="frm_txt" name="Usuario" value="'.$registro['Usuario'].'" /></td>
											</tr>
											<tr>
											...
											<td>Perfil:</td>
											<td>
												<select name="Perfil" class="frm_cmb"/>
											...
											<tr>
											<td>Veces que el usuario ha iniciado sesión:</td>
											<td><input type="text" readonly="readonly" class="frm_txt" name="Contador" value="'.$registro['Contador'].'" /></td>
											</tr> 
											<tr>
											...
											<input  type="submit" value="Re-Iniciar Clave" class="frm_btn" name="reiniciar"/>
											<input  type="submit" value="Desactivar" class="frm_btn" name="desactivar"/>
										...
										case 'post':
											...
											if (isset($_POST['Perfil'])==false or $_POST['Perfil']=="")
											{
												echo '<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#ce2700;">
											...
											{
												require_once("logica/log_usuarios.php");
												$resultado=log_actualizar_usuario($_POST,$_GET['id']);
												echo'<div style="background:url(imagenes/msg_green.png) no-repeat; padding:10px 10px 10px 10px; Color:#6da827;">
											...
											<tr>
											<td>Veces que el usuario ha iniciado sesión:</td>
											<td><input type="text" class="frm_txt" name="Contador" value="'.(isset($_POST['Contador'])?$_POST['Contador']:'').'" /></td>
											</tr>


											<tr>
											<td colspan="2" align="center">
											<input  type="submit" value="Actualizaggr"  class="frm_btn" name="aceptar"/>
