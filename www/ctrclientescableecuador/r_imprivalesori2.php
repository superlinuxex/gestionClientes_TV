 ...
 while ( $fila = mysql_fetch_array($resultado))
  ...
  if($cuentavales==1)
   ...
   if(isset($resultado8))
    ...
    echo '
    <tr>
    <td style="position:absolute;left:310px;top:'.$cuentalin.'px;width:50px;height:45px;font-size:24px">Fecha:'.$fila['fecha'].'</td>
    </tr>';
    $cuentalin=$cuentalin+80;
    echo '
    <tr>
    <td style="position:absolute;left:120px;top:'.$cuentalin.'px;width:400px;height:37px;font-size:24px">Materiales--:'.$ntipoa.'</td>
    </tr>';
    $cuentalin=$cuentalin+10;
    echo '
    <tr>
    <td style="position:absolute;left:3px;top:'.$cuentalin.'px;width:400px;height:37px;font-size:24px">Vale Retiro</td>
    ...
    echo '
    <tr>
    <td style="position:absolute;left:120px;top:'.$cuentalin.'px;width:400px;height:37px;font-size:24px">Repuestos--:'.$ntipob.'</td>
    </tr>';
    $cuentalin=$cuentalin+40;
    echo '
    <tr>
    <td style="position:absolute;left:3px;top:'.$cuentalin.'px;width:400px;height:37px;font-size:24px">Bodega:'.$cod_bodega.'</td>
    </tr>';
    $cuentalin=$cuentalin+30;
    echo '
    <tr>
    <td style="position:absolute;left:3px;top:'.$cuentalin.'px;width:400px;height:37px;font-size:24px">Division:'.$xdivis.'</td>
    <td style="position:absolute;left:240px;top:'.$cuentalin.'px;width:400px;height:37px;font-size:24px">Obra:'.$xobra.'</td>
    </tr>';
    $cuentalin=$cuentalin+30;
    echo '
    <tr>
    <td style="position:absolute;left:3px;top:'.$cuentalin.'px;width:400px;height:37px;font-size:24px">Partida:'.$xpartida.'</td>
    <td style="position:absolute;left:240px;top:'.$cuentalin.'px;width:400px;height:37px;font-size:24px">Sub Partida:'.$xsubpartida.'</td>
    </tr>';
    $cuentalin=$cuentalin+30;
    echo '
    <tr>
    <td style="position:absolute;left:3px;top:'.$cuentalin.'px;width:400px;height:37px;font-size:24px">'.$xnsubpartida.'</td>
    </tr>';
    $cuentalin=$cuentalin+30;
    echo '
    <tr>
    <td style="position:absolute;left:3px;top:'.$cuentalin.'px;width:400px;height:37px;font-size:24px">Equipo:'.$xnequipo.'</td>
    </tr>';
    $cuentalin=$cuentalin+30;
    echo '
    <tr>
    <td style="position:absolute;left:1px;top:'.$cuentalin.'px;width:405px;height:37px">_________________________________________________________________________</td>
    </tr>';
    $cuentalin=$cuentalin+20;
    echo '
    <tr>
    <td class="FilaN" style="position:absolute;left:1px;top:'.$cuentalin.'px;width:90px;height:37px;font-size:24px">Codigo</td>
    <td class="FilaN" style="position:absolute;left:90px;top:'.$cuentalin.'px;width:150px;height:37px;font-size:24px">Despachado</td>
    <td class="FilaN" style="position:absolute;left:225px;top:'.$cuentalin.'px;width:275px;height:37px;font-size:24px;text-align:center">Descripcion</td>
    <td class="FilaNF" style="position:absolute;left:475px;top:'.$cuentalin.'px;width:100px;height:37px;font-size:24px">Precio $</td>
    </tr>';
    $cuentalin=$cuentalin+40;
    echo '
    <tr>
    <td class="FilaN" style="position:absolute;left:1px;top:'.$cuentalin.'px;width:90px;height:37px;font-size:24px">'.$xarti.'</td>
    <td class="FilaN" style="position:absolute;left:90px;top:'.$cuentalin.'px;width:150px;height:37px;font-size:24px">'.$xcanti.'</td>
    <td class="FilaN" style="position:absolute;left:225px;top:'.$cuentalin.'px;width:275px;height:37px;font-size:24px;text-align:left">'.$xnomarti.'</td>
    <td class="FilaNF" style="position:absolute;left:475px;top:'.$cuentalin.'px;width:100px;height:37px;font-size:24px">'.$xprecio.'</td>
    </tr>';
    $cuentalin=$cuentalin+40;
    echo '
    <tr>
    <td style="position:absolute;left:3px;top:'.$cuentalin.'px;width:200px;height:37px;font-size:24px">A utilizar en:'.$xutilen.'</td>
    </tr>';
    $cuentalin=$cuentalin+10;
    echo '
    <tr>
    <td style="position:absolute;left:360px;top:'.$cuentalin.'px;width:200px;height:37px;font-size:24px">|</td>
    </tr>';
    $cuentalin=$cuentalin+10;
    echo '
    <tr>
    ...
    echo '
    <tr>
    <td style="position:absolute;left:360px;top:'.$cuentalin.'px;width:200px;height:37px;font-size:24px">|'.$xautoriza.'</td>
    </tr>';
    $cuentalin=$cuentalin+10;
    echo '
    <tr>
    <td style="position:absolute;left:3px;top:'.$cuentalin.'px;width:405px;height:37px">_______________________________________________________________________</td>
    </tr>';
  }         
  //segundo vale
  if($cuentavales==2)
   ...
   if(isset($resultado8))
    ...
    echo '
    <tr>
    <td style="position:absolute;left:900px;top:'.$cuentalin2.'px;width:50px;height:45px;font-size:24px">Fecha:'.$fecha.'</td>
    </tr>';
    $cuentalin2=$cuentalin2+80;
    echo '
    <tr>
    <td style="position:absolute;left:710px;top:'.$cuentalin2.'px;width:400px;height:37px;font-size:24px">Materiales--:'.$ntipoa.'</td>
    </tr>';
    $cuentalin2=$cuentalin2+10;
    echo '
    <tr>
    <td style="position:absolute;left:590px;top:'.$cuentalin2.'px;width:400px;height:37px;font-size:24px">Vale Retiro</td>
    ...
    echo '
    <tr>
    <td style="position:absolute;left:710px;top:'.$cuentalin2.'px;width:400px;height:37px;font-size:24px">Repuestos--:'.$ntipob.'</td>
    </tr>';
    $cuentalin2=$cuentalin2+40;
    echo '
    <tr>
    <td style="position:absolute;left:590px;top:'.$cuentalin2.'px;width:400px;height:37px;font-size:24px">Bodega:'.$cod_bodega.'</td>
    </tr>';
    $cuentalin2=$cuentalin2+30;
    echo '
    <tr>
    <td style="position:absolute;left:590px;top:'.$cuentalin2.'px;width:400px;height:37px;font-size:24px">Division:'.$xdivis.'</td>
    <td style="position:absolute;left:830px;top:'.$cuentalin2.'px;width:400px;height:37px;font-size:24px">Obra:'.$xobra.'</td>
    </tr>';
    $cuentalin2=$cuentalin2+30;
    echo '
    <tr>
    <td style="position:absolute;left:590px;top:'.$cuentalin2.'px;width:400px;height:37px;font-size:24px">Partida:'.$xpartida.'</td>
    <td style="position:absolute;left:830px;top:'.$cuentalin2.'px;width:400px;height:37px;font-size:24px">Sub Partida:'.$xsubpartida.'</td>
    </tr>';
    $cuentalin2=$cuentalin2+30;
    echo '
    <tr>
    <td style="position:absolute;left:590px;top:'.$cuentalin2.'px;width:400px;height:37px;font-size:24px">'.$xnsubpartida.'</td>
    </tr>';
    $cuentalin2=$cuentalin2+30;
    echo '
    <tr>
    <td style="position:absolute;left:590px;top:'.$cuentalin2.'px;width:400px;height:37px;font-size:24px">Equipo:'.$xnequipo.'</td>
    </tr>';
    $cuentalin2=$cuentalin2+30;
    echo '
    <tr>
    <td style="position:absolute;left:590px;top:'.$cuentalin2.'px;width:405px;height:37px">_______________________________________________________________________</td>
    </tr>';
    $cuentalin2=$cuentalin2+20;
    echo '
    <tr>
    <td class="FilaN" style="position:absolute;left:590px;top:'.$cuentalin2.'px;width:105px;height:37px;font-size:24px">Codigo</td>
    <td class="FilaN" style="position:absolute;left:700px;top:'.$cuentalin2.'px;width:150px;height:37px;font-size:24px;text-align:left">Despachado</td>
    <td class="FilaN" style="position:absolute;left:820px;top:'.$cuentalin2.'px;width:275px;height:37px;font-size:24px;text-align:center">Descripcion</td>
    <td class="FilaNF" style="position:absolute;left:1040px;top:'.$cuentalin2.'px;width:100px;height:37px;font-size:24px">Precio $</td>
    </tr>';
    $cuentalin2=$cuentalin2+40;
    echo '
    <tr>
    <td class="FilaN" style="position:absolute;left:590px;top:'.$cuentalin2.'px;width:105px;height:37px;font-size:24px">'.$xarti.'</td>
    <td class="FilaN" style="position:absolute;left:700px;top:'.$cuentalin2.'px;width:150px;height:37px;font-size:24px">'.$xcanti.'</td>
    <td class="FilaN" style="position:absolute;left:820px;top:'.$cuentalin2.'px;width:275px;height:37px;font-size:24px;text-align:left">'.$xnomarti.'</td>
    <td class="FilaNF" style="position:absolute;left:1040px;top:'.$cuentalin2.'px;width:100px;height:37px;font-size:24px">'.$xprecio.'</td>
    </tr>';
    $cuentalin2=$cuentalin2+40;
    echo '
    <tr>
    <td style="position:absolute;left:590px;top:'.$cuentalin2.'px;width:200px;height:37px;font-size:24px">A utilizar en:'.$xutilen.'</td>
    </tr>';
    $cuentalin2=$cuentalin2+10;
    echo '
    <tr>
    <td style="position:absolute;left:970px;top:'.$cuentalin2.'px;width:200px;height:37px;font-size:24px">|</td>
    </tr>';
    $cuentalin2=$cuentalin2+10;
    echo '
    <tr>
    ...
    echo '
    <tr>
    <td style="position:absolute;left:970px;top:'.$cuentalin2.'px;width:200px;height:37px;font-size:24px">|'.$xautoriza.'</td>
    </tr>';
    $cuentalin2=$cuentalin2+10;
    echo '
    <tr>
