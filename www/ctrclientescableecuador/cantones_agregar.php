...
<title>Customerscabletv - Mantenimiento de zonas</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Agregar Poblacion</a></h3>
							<div class="entry">
								<?php
									...
									{
										echo '<META HTTP-EQUIV="Refresh" Content="0; URL=cantones.php?part='.$_GET["part"].'&s_part='.$_GET["s_part"].'">';
										exit;    
									}
									...
									require_once("logica/log_cantones.php");
										if (isset($_POST['Codigo'])==false or $_POST['Codigo']=="")
										{
											...
											Debe ingresar el Codigo para la zona que desea ingresar
											</div>';
											$insertar=false;
										}
										if ($insertar==true)
										{
											$canton_existe = log_validar_existencia_canton($_GET["part"],$_GET["s_part"],$_POST['Codigo']);
											if ($canton_existe==true)
											{
												echo '<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#ce2700;">
												El codigo de la zona ingresado ya existe 
												</div>';
												$insertar=false;
											}
										}
										...
										{
											echo '<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#ce2700;">
											Debe ingresar el Nombre de la zona que desea ingresar
											</div>';
											$insertar=false;
										}
										if ($insertar==true)
										{
											$resulatado=log_insertar_canton($_POST);
									...
									echo '<form method="POST" id="id-form" action="'.$_SERVER["PHP_SELF"].'?part='.$_GET["part"].'&s_part='.$_GET["s_part"].'" >';
