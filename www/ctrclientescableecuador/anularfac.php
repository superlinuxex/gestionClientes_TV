...
<title>Customerscabletv- Anular factura de cliente </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Registro de anulacion de facturas</a></h3>
							<div class="entry">
								<?php
								...
								if ($registro['Anulada']=="1")
								{
											...
											ADVERTENCIA: Esta factura ya esta anulada, imposible anular.
											</div>';
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=facturasanu.php">';    
											exit;  
									...
									switch ($mostrar_datos)
									{
										case 'get':
											...
											<tr>
													...
													<tr>
													<td>Factura o credito fiscal:</td>
													...
													<td><input type="text" class="frm_txt_long" name="Motivo" value="'.$registro['Motivo'].'" /></td>
													</tr>

													<tr>
													<td>Clasifique el motivo:</td>
													<td>
													<select name="Cmotivo" class="frm_cmb" />
													<option value="">Seleccione un motivo...</option>';
													require_once("./logica/log_facturas.php");
													$resultado=log_obtener_motianu_cmb();
													while ( $fila = mysql_fetch_array($resultado))
													{
														if ($fila['Codigo']==$registro['Cmotivo'])
														{
							...
							case 'post':
								...
								if (isset($_POST['Fechai'])==false or $_POST['Fechai']=="")
								{
									...
									Debe ingresar la fecha de anulacion
									</div>';
									$insertar=false;
									echo '<META HTTP-EQUIV="Refresh" Content="0; URL=facturasanu.php">';    
									exit;  
											...
											if ($insertar==true)
											{
												$resultado=log_anular_factura($_POST);
									...
									<tr>
									<td>Motivo de anulacion:</td>
									<td><input type="text" class="frm_txt_long" name="Motivo" value="'.(isset($_POST['Motivo'])?$_POST['Motivo']:'').'" /></td>
									</tr>
