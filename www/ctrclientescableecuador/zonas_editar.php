...
<title>Customerscabletv - Editar Zona </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Editar zona de cobertura</a></h3>
							<div class="entry">
								<?php
									require_once("logica/log_zonas.php");
									$tabla=log_obtener_zona2($_GET["id"]);
									...
									switch ($mostrar_datos)
									{
										...
										case 'post':
											if (isset($_POST['Nombre'])==false or $_POST['Nombre']=="")
											{
												...
												Debe ingresar el Nombre para la zona que desea cambiar
												</div>';
												$insertar=false;
											}
											...
											if ($insertar==true)
											{
												$resultado=log_actualizar_zona($_POST,$_GET['id']);
