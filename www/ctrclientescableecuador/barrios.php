		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Mantenimiento de registro de Barrio</a></h3>
							<h3 class="title">Datos del Estado seleccionado</a></h3>
							<div class="entry">
								<div id="itsthetable">
								<?php
										...
										echo "<br/><h3 class=\"title\">Barrios de la Poblacion seleccionada</a></h3>";
										$parm='?part='.$_GET["part"].'&s_part='.$_GET["s_part"].'&s_part_a='.$_GET["s_part_a"].'&s_part_b=';
										$barrios=log_obtener_barrios($_GET["part"],$_GET["s_part"],$_GET["s_part_a"]);
										$campos = array("Codigo","Zona","Localidad");
										crear_tabla($barrios, $campos,'barrios','barrios.php',false,"barrios_editar.php".$parm,
										"barrios_eliminar.php".$parm,$parm,"barrios_agregar.php?part=".$_GET["part"]."&s_part=".$_GET["s_part"].'&s_part_a='.$_GET["s_part_a"]);
                                    ?>
									<br/>
                              </div>
						  </div>
