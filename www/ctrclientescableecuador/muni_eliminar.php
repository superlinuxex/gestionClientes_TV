		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Eliminar Municipios</a></h3>
							<div class="entry">
								<?php
									...
									echo '<form method="POST" id="id-form" action="'.$_SERVER["PHP_SELF"].'?id='.$_GET["id"].'&id2='.$_GET["id2"].'">';
									switch ($mostrar_datos)
									{
										...
										case 'post':
											...
											if ($insertar==true)
											{
												$resultado=log_eliminar_muni($_POST,$_GET['id2']);
