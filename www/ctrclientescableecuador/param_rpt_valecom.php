...
<title>S I C I O - Impresión de Vale de Salida de Combustibles </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h2 class="title"><a href="#">Parametros para la Impresion del Vale de Combustibles</a></h2>
							<div class="entry">
								<?php
									if (isset ($_POST['aceptar']))
									{
										...
										if (isset($_POST['Vale'])==false or $_POST['Vale']=="")
										{
											...
											Debe especificar el numero de vale.
											</div>';
											$insertar=false;
										}
										...
										if ($insertar==true)
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=r_valecomb.php?
									...
									<tr>
									<td>Numero de Vale de Salida:</td>
