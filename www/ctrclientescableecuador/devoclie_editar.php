...
<title>Customerscabletv- Editar devolucion de clientes </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Editar Registro de devolucion de clientes</a></h3>
							<div class="entry">
								<?php
									...
									<td><input type="text" class="frm_txt"  name="Fechafac" id="Fechafac" value="'.$registro['Fechafac'].'" /></td>
									</tr>
							...
							case 'post':
										...
										if (isset($_POST['Empleado'])==false or $_POST['Empleado']=="")
										{
											...
											if ($insertar==true)
											{
												$resultado=log_actualizar_devoclie($_POST,$_GET['id'],$bodx);
