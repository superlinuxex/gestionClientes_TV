...
<title>CUSTOMERSCABLETV - Agregar equipo adicional en plan</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Agregar equipo adicional en promocion</a></h3>
							<div class="entry">
								<?php
									...
									if (isset ($_POST['aceptar']))
									{
										...
										if ($insertar==true)
										{
											$resultado=log_insertar_equiad($_POST);
                 									IF($resultado==1){
