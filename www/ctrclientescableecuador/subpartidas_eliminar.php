...
<title>S I C I O - Eliminar Sub-Partida</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h2 class="title">Eliminar Sub-Partida de:</a></h2>
							<div class="entry">
								<?php
									...
									if (isset ($_POST['aceptar']))
									   {
									      $resultado=dat_validar_existencia_subpartida_a1($_GET["part"],$_GET["div"],$_GET["pro"],$_GET["s_part"]);
									      if ($resultado)
										{
										...
										{
										$resulatado=log_eliminar_subpartida($_GET["part"],$_GET["div"],$_GET["pro"],$_GET["s_part"]);
