										...
										if (isset ($_POST['Localizar']))
										   {
											...
											crear_tabla($salidas, $campos,'facturaselim','facturaselim.php',false,"facturas_encabezado_editar.php",
											"eliminarfac.php","facturas_ver_detallea.php","facturas_agregar.php");
											echo "<div style=\"padding:15px;\" align=\"center\">";
											paginacion ($num_pag,$total_registros,"facturaselim.php?pagina=");
											echo"</div>";
										   }
                                                                                 else
										 {
