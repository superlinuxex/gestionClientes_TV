										...
										<table style="border: 0px solid #00F" >
											<tr style="border: 0px solid #00F">
												<td style="border: 0px solid #00F">
													...
													<option value="2">Ventas por Factura</option>

												</td>
												<td style="border:0px solid;width:460px;">
													<input  type="submit" value="Nuevo Pago"  class="frm_btn" name="Continuar"/>
												</td>
											</tr>
										...
										if (isset ($_POST['Localizar']))
										   {
											...
											"imprimir_recibo.php","facturas_ver_detalle.php","facturas_agregar.php");
