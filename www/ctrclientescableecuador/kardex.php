		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Existencias de articulos en bodega actual</a></h3>
							<div class="entry">
								<div id="itsthetable">
                                	<?php
									$bodx=$_SESSION["idBodega"];
										...
										if (isset ($_POST['Buscar']))
										{
											...
											$campos = array("Codigo","Descripcion","Exist.Nuevo","Exist.Usado","UMedida");										
											crear_tabla($idkardex, $campos,'kardex','kardex.php',false,"kardex_editar.php",
											"kardex_eliminar.php","kardex_detalle.php","kardex_agregar.php","imprimehoja.php");
											echo "<div style=\"padding:15px;\" align=\"center\">";
											//paginacion ($num_pag,$total_registros,"kardex.php?pagina=");
											echo"</div>";   
										}
										else
										{
