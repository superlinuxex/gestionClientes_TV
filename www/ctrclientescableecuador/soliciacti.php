...
<title>Ervingsoftware- Programa solicitar actividad tecnica desde llamadas a clientes </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Registro de solicitud de atencion tecnica a clientes</a></h3>
							<div class="entry">
								<?php
									...
									<tr>
									<td>Tipo de actividad tecnica:</td>
									<td>
									...
									<input  type="submit" value="Guardar solicitud"  class="frm_btn" name="aceptar"/>
							...
							case 'post':
								if (isset($_POST['Tconexion'])==false or $_POST['Tconexion']=="")
								{
									...
									Debe de ingresar el tipo de actividad que se realizara
									</div>';
									$insertar=false;
									echo '<META HTTP-EQUIV="Refresh" Content="0; URL=llamadas.php">';    
									exit;  
								...
								{
									echo '<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#000000;">
									Debe ingresar la fecha que solicita la visita
									</div>';
									$insertar=false;
									echo '<META HTTP-EQUIV="Refresh" Content="0; URL=llamadas.php">';    
									exit;  
								...
								if ($insertar==true)
								{
									$resultado=log_conectar_idenpaci2($_POST,$_GET['id'],$bodx);
								...
								if ($insertar==false)
								 ...
								 <table style="border:hidden; padding:0px 0px 0px 0px; border-style:hidden; outline-style:hidden"; cellpadding="0"; cellspacing="0"; border="0;" >
									...
									$resultado=log_obtener_servicio_cmbconec();
									while ( $fila = mysql_fetch_array($resultado))
									 {
									  if (isset($_POST["Tconexion"]))
									   {
