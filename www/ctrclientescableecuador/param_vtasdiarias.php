...
<title>Customerscabletv - ventas diarias</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title"><a href="#">Parametros para generar el resumen de ventas diarias</a></h3>
							<div class="entry">
								<?php
									...
									if (isset ($_POST['aceptar']))
									{
										...
										if ($insertar==true)
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=rpt_vtasdiarias.php?
									...
									<td><input type="hidden" class="frm_txt" name="Tipoinfo" value="'.(isset($_POST['Tipoinfo'])?$_POST['Tipoinfo']:'').'" /></td>
