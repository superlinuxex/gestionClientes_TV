...
<title>S I C I O - Reporte de Movimientos de Bodega </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h2 class="title"><a href="#">Parametros para la generacion del reporte de Movimientos</a></h2>
							<div class="entry">
								<?php
									if (isset ($_POST['aceptar']))
									{
										...
										if (isset($_POST['FechaD'])==false or $_POST['FechaD']=="")
										{
											...
											Debe ingresar la Fecha desde la cual se mostraran los movimeintos.
											</div>';
											$insertar=false;
										}
										...
										if ($insertar==true)
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=rpt_movimientos.php?
