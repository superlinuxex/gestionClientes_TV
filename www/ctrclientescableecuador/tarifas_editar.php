...
<title>Customerscabletv - Editar tarifas de planes</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Editar tarifas de planes</a></h3>
							<div class="entry">
								<?php
									require_once("logica/log_tarifas.php");
									$tabla=log_obtener_tarifas($_GET["id"]);
									...
									else
									{
										...
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=tarifas.php">';    
											exit;  
										}
										else
										{
									...
									switch ($mostrar_datos)
									{
										case 'get':
											...
											<tr>
											<td>Por acumulado:</td>
											<td><input type="text" class="frm_txt" name="Poracum" value="'.$registro['Poracum'].'" /></td>
											</tr>
											<tr>
										...
										case 'post':
											...
											if (isset($_POST['Costo'])==false or $_POST['Costo']=="")
											{
												echo '<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#ce2700;">
											...
											if ($insertar==true)
											{
												$resultado=log_actualizar_tarifas($_POST,$_GET['id']);
											...
											<tr>
											<td>Por acumulacion:</td>
											<td><input type="text" class="frm_txt" name="Poracum" value="'.(isset($_POST['Poracum'])?$_POST['Poracum']:'').'" /></td>
											</tr>
											<tr>
