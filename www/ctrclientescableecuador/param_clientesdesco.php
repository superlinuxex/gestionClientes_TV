...
<title>SICCAE - Reporte de clientes desconectados a la fecha</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title"><a href="#">Parametros para la Generacion del Reporte clientes desconectados</a></h3>
							<div class="entry">
								<?php
									if (isset ($_POST['aceptar']))
									{
										...
										if ($insertar==true)
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=rpt_clidesco.php?
