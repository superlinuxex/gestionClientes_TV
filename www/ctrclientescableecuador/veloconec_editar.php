...
<title>Customerscabletv - Editar velocidad de conexion</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Editar velocidad de conexion</a></h3>
							<div class="entry">
								<?php
									require_once("logica/log_veloconec.php");
									$tabla=log_obtener_veloconec($_GET["id"]);
									...
									else
									{
										...
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=veloconec.php">';    
											exit;  
										}
										else
										{
									...
									switch ($mostrar_datos)
									{
										...
										case 'post':
											...
											if ($insertar==true)
											{
												$resultado=log_actualizar_veloconec($_POST,$_GET['id']);
