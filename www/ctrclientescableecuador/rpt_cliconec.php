...
if($_GET['ti']==1)
 {
  ...
  //clientes conectados
	...
	$resultado=log_obtener_clientes_conec($_GET['fd'],$_GET['fh'],$_GET['moti'],$_GET['servi'],$_GET['bod']);
...
<title>CUSTOMERSCABLETV - Reporte de clientes conectados</title>
</head>
<body>
	<div style="position:absolute;top:15px;border:1px no-solid;width:100%;height:98%;">
		...
		<table cellspacing="0" class="Tabla1" style="position:absolute;left:1px;top:130px;width:98%;">
			<tr>
				...
				<td class="FilaN" style="height: 22px"><strong>Servicio conectado</strong></td>
				<td class="FilaN" style="height: 22px"><strong>Valor del plan</strong></td>
			...
			while ( $filaz = mysql_fetch_array($resultado))
			{
			    ...
			    //$xdireccion=$xvivienda;
				    ...
				    $xpoligono=$filaz['poligono'];
		      		    $xcasa=$filaz['casa'];
		                    ...
		                    $xfechacon=$filaz['fechai'];
		                    $xplan1=$filaz['ttplan'];
		                    $xobserva=$filaz['observacion'];
                                    $xvalplan=$filaz['valorplan'];

				//buscando nombre del plan
				  $xplan="";
				  $sentencian = "select nombre_plan FROM planes where cod_plan='".$xplan1."'"; 
				...
				if($xblocke!="")
				{
				 $tbloque="Block.";
        	                ...
        	                $cerouno=1;
				$xdireccion=$xnmuni.",".$tcaserio.$xncaserio;

			        echo '
					<tr>
						<td class="FilaNI" style="height: 22px; font-size:13px; text-align: center">'.$cliente.'</td>
						<td class="FilaN" style="height: 22px; font-size:13px; text-align: left">'.$ncliente.'</td>
						<td class="FilaN" style="height: 22px; font-size:13px; text-align: center">'.$xfechai.'</td>
						<td class="FilaN" style="height: 22px; font-size:13px; text-align: center">'.$xfechaul.'</td>
						<td class="FilaN" style="height: 22px; font-size:13px; text-align: center">'.$xfechacon.'</td>
						<td class="FilaN" style="height: 22px; font-size:13px; text-align: center">'.$xplan.'</td>
						<td class="FilaN" style="height: 22px; font-size:13px; text-align: center">'.$xvalplan.'</td>
						<td class="FilaN" style="height: 22px; font-size:13px; text-align: center">'.$xobserva.'</td>
						<td class="FilaNF" style="height: 22px;font-size:13px; text-align:left">'.$xdireccion.'</td>
					</tr>';	
				...
				<td class="FilaN2" style="height: 22px"><strong>Fecha conexion</strong></td>
				...
				<td class="FilaN2" style="height: 22px"><strong>Servicio conectado</strong></td>
				<td class="FilaN2" style="height: 22px"><strong>Valor del plan</strong></td>
				...
				<td class="FilaNF2" style="height: 22px;text-align: center;padding-right:0px;"><strong>Direccion</strong></td>
                        ...
                        $sumaplanes=number_format($planes, 2, ".", ",");
			$sumatotalgen=number_format($sumalineas, 0, ".", ",");
		        echo '
			<tr>
			<td class="FilaNI2" style="height: 22px; font-size:13px; text-align: center"></td>
			<td class="FilaN2" style="height: 22px; font-size:13px; text-align: left"></td>
			<td class="FilaN2" style="height: 22px; font-size:13px; text-align: center"></td>
			<td class="FilaN2" style="height: 22px; font-size:13px; text-align: center"></td>
			<td class="FilaN2" style="height: 22px; font-size:13px; text-align: center"></td>
			<td class="FilaN2" style="height: 22px; font-size:13px; text-align: center">TOTAL</td>
			<td class="FilaN2" style="height: 22px; font-size:13px; text-align: center">'.$sumaplanes.'</td>
			<td class="FilaN2" style="height: 22px; font-size:13px; text-align: center"></td>
			<td class="FilaNF2" style="height: 22px;font-size:13px; text-align: left">'.$sumatotalgen.'</td>
			</tr>';	
			echo'
		</table>
	</div>
...
if($_GET['ti']==2)
 {
  ...
  $_GET['servi']=0;
	require_once("./logica/log_reportes.php");
	$resultado=log_obtener_clientes_desco($_GET['fd'],$_GET['fh'],$_GET['moti'],$_GET['servi'],$_GET['bod']);
...
<title>Customerscabletv - Reporte de clientes desconectados</title>
</head>
<body>
	<div style="position:absolute;top:15px;border:1px no-solid;width:100%;height:98%;">
	
		<div style="position:absolute;left:100px;top:50px;width:800px;height:37px;text-align:center;z-index:0;">
			<span style="color:#000000;font-family:Arial;font-size:32px;"><strong>Reporte de clientes desconectados a la fecha</strong></span>
		</div>
		<div style="position:absolute;left:850px;top:10px;width:350px;height:22px;z-index:1;">
			<span style="color:#000000;font-family:Arial;font-size:12px;"><strong>Fecha: </strong>'.date('d/m/Y').'</span>
		</div>
		...
		<table cellspacing="0" class="Tabla1" style="position:absolute;left:1px;top:130px;width:98%;">
			<tr>
				...
				<td class="FilaN" style="height: 22px"><strong>Fecha Ul.Pago</strong></td>
				<td class="FilaN" style="height: 22px"><strong>Motivo de desconexion</strong></td>
				<td class="FilaNF" style="height: 22px;text-align: center;padding-right:0px;"><strong>Direccion</strong></td>
			</tr>';	
                        $cuentafila=1;
                        $sumalineas=0;
	 ...
	 $nmotivo="";
         $sentencia2 = "select nombremot FROM tablamoti where codigomot='".$xmotidesco."'"; 
         $resultado2 = mysql_query($sentencia2);
         if(isset($resultado2))
	  {
	   if(mysql_num_rows ( $resultado2 )!=0)
	     {
	      ...
	      $nmotivo=$row['nombremot'];
					...
					<tr>
						...
						<td class="FilaN" style="height: 22px; font-size:13px; text-align: center">'.$xfechai.'</td>
						<td class="FilaN" style="height: 22px; font-size:13px; text-align: center">'.$xfechaul.'</td>
						<td class="FilaN" style="height: 22px; font-size:13px; text-align: center">'.$nmotivo.'</td>
						<td class="FilaNF" style="height: 22px;font-size:13px; text-align:left">'.$xdireccion.'</td>
					</tr>';	
				...
				<td class="FilaN2" style="height: 22px"><strong>Fecha Ul.Pago</strong></td>
				<td class="FilaN2" style="height: 22px"><strong>Motivo de desconexion</strong></td>
				<td class="FilaNF2" style="height: 22px;text-align: center;padding-right:0px;"><strong>Direccion</strong></td>
				 </tr>';	
        	                 $cuentafila=1;
	                        }
