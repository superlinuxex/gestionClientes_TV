	  ...
	  if(((intval(substr($filaz['ulfepago2'],5,2)))<=$xmex2 or $xanio2>intval(substr($filaz['ulfepago2'],0,4))) and $filaz['ulfepago1']!='Null' and $filaz['ulfepago2']!='Null');	   
	   {
            ...
            if(intval(substr($ff2,0,4))>intval(substr($hoymes1,6,4)))   //si el mes pagado es menor de noviembre    
	    {
		 $mesasumar=0;
                ...
                $debedias=0;
                $apagarday=0;
                   if(intval(substr($ff2,5,2))==intval(substr($ff1,5,2)))   //esto se da cuando el periodo inicia con dia diferente de 01 (dias de servicio)
                   {
                     ...
                     if($mesasumar>1)
			{
		     ...
		     $sentencia="update clientes set parametrompendi='".$mesasumar."',parametroapa='".$apagar."' where cod_cliente='".$cliente."' and sucursal='".$cod_bodega."'";
                     ...
                     //       $mesesdias=1;
                 	//    $sentencia="update clientes set parametrompendi='".$mesesdias."',parametroapa='".$apagarday."' where cod_cliente='".$cliente."' and fechap2!='Null' and sucursal='".$cod_bodega."'";
	                //    $resultado2 = mysql_query($sentencia);
                     //}
...
<body>
	<div style="position:absolute;top:15px;border:1px no-solid;width:100%;height:98%;">
		...
		<table cellspacing="0" class="Tabla1" style="position:absolute;left:1px;top:100px;width:98%;">
			...
			<tr>
				<td class="FilaNIS" style="height: 22px;font-size:17px; left:1px;width:900px"><strong>No.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp Nombres&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp  Apellidos&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp   Direccion&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp  Telefono&nbsp;&nbsp;&nbsp;&nbsp;&nbsp    Sector&nbsp Caja&nbsp Meses/Dias&nbsp;&nbsp;&nbsp Desde&nbsp;&nbsp;&nbsp  Total&nbsp;&nbsp Hoy</strong></td>
			</tr>';	
...
//}
   ...
   if($inicio>1)
    ...
    echo '
    <tr>
    <td style="position:absolute;left:1px;top:'.$cuentalin.'px;width:900px;height:37px">No.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp Nombres&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp  Apellidos&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp   Direccion&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp  Telefono&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp    Sector&nbsp Caja&nbsp Meses/Dias&nbsp;&nbsp;&nbsp Desde&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp Total&nbsp;&nbspHoy</td>
    </tr>';
    ...
    echo '
    <tr>
    <td style="position:absolute;left:1px;top:'.$cuentalin.'px;width:400px;height:37px;font-size:18px;text-align:left">'.$correlativo.'</td>
    <td style="position:absolute;left:50px;top:'.$cuentalin.'px;width:110px;height:37px;font-size:17px;text-align:left">'.$ncliente.'</td>
    <td style="position:absolute;left:160px;top:'.$cuentalin.'px;width:110px;height:37px;font-size:17px;text-align:left">'.$acliente.'</td>
    <td style="position:absolute;left:280px;top:'.$cuentalin.'px;width:220px;height:37px;font-size:17px">'.$xdireccion.' - '.$xrefer.'</td>
    <td style="position:absolute;left:500px;top:'.$cuentalin.'px;width:50px;height:37px;font-size:17px">'.$xtel.' - '.$xcel.'</td>
    <td style="position:absolute;left:600px;top:'.$cuentalin.'px;width:20px;height:37px;font-size:17px">'.$xsector.'</td>
    <td style="position:absolute;left:650px;top:'.$cuentalin.'px;width:20px;height:37px;font-size:17px">'.$xcaja.'</td>
    <td style="position:absolute;left:700px;top:'.$cuentalin.'px;width:20px;height:37px;font-size:17px">'.$xmesespen.'</td>
    <td style="position:absolute;left:725px;top:'.$cuentalin.'px;width:20px;height:37px;font-size:17px">'.$xdiaspendi.'</td>
    <td style="position:absolute;left:765px;top:'.$cuentalin.'px;width:50px;height:37px;font-size:17px">'.$ttfecha1.' A '.$ttfecha2.'</td>
    <td style="position:absolute;left:835px;top:'.$cuentalin.'px;width:80px;height:37px;font-size:18px">'.$xapagar.'</td>
    <td style="position:absolute;left:900px;top:'.$cuentalin.'px;width:80px;height:37px;font-size:18px">'.$xapagartot.'</td>
    </tr>';
