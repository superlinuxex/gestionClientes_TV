		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Generar Reporte de Cortes de Caja</h3>
							<div class="entry">
								<?php
									...
									if (isset ($_POST['aceptar']))
									{
										...
										if ($insertar==true)
										{
											...
											&ti='.(isset($_POST['Mcod_vende'])?$_POST['Mcod_vende']:'').'
									...
									if (isset ($_POST['aceptar2']))
									{
										...
										if ($insertar==true)
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=pagosreci_pdf.php?
									...
									$resultado=log_obtener_usuarios_cmb();
