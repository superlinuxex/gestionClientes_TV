...
<title>SICCAE - Reporte de clientes desconectados con mora</title>
							...
							<div class="entry">
								<?php
									...
									if (isset ($_POST['aceptar']))
									{
										...
										if ($insertar==true)
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=rpt_clidescomx.php?
									...
									<td>
										<select name="Tipoinfo" class="frm_cmb">
											<option value="1" '.(isset($_POST['Tipoinfo'])?($_POST['Tipoinfo']==1?' selected="selected" ':''):'').'>Clientes desconectados con moras</option>
											<option value="2" '.(isset($_POST['Tipoinfo'])?($_POST['Tipoinfo']==2?' selected="selected" ':''):'').'>Historial de pago de clientes con mora</option>
										</select>
									</td>
									</tr>
