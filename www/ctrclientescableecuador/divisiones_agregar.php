...
<title>Customerscabletv- Agregar Categoria</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Agregar Tipo de Articulo</a></h3>
							<div class="entry">
								<?php
									...
									{
										echo '<META HTTP-EQUIV="Refresh" Content="0; URL=divisiones.php">';    
										exit;    
									}
									if (isset ($_POST['aceptar']))
									{
										...
										if ($insertar==true)
										{
											$resultado=log_insertar_division($_POST);
                 									IF($resultado==1){
											...
											{
											 echo'<div style="background:url(imagenes/msg_green.png) no-repeat; padding:10px 10px 10px 10px; Color:#6da827;">
											 Registro ya existe en el catalogo, imposible adicionarlo.	
											</div>';
											}
											unset($_POST);
										echo '<META HTTP-EQUIV="Refresh" Content="0; URL=divisiones.php">';    
