...
<title>SICCAE- Historico de clientes </title>
									...
									else
									{
										if (isset($_POST['facturas']))
										{
										 ...
										 if(!isset($_GET["pagina"]))
										  ...
										  $campos = array("Factura","Fecha","Concepto","Cantidad","Precio","Total");
										  crear_tabla($listafac, $campos,'listafac','histocliecobro.php',false,"listafac_editar.php",
										  "listafac_eliminar.php","listafac.php","histocliecobro.php?id=$regis","vacio.php");
										  echo "<div style=\"padding:15px;\" align=\"center\">";
										  //paginacion ($num_pag,$total_registros,"histocliecobro.php?pagina=");
										  echo"</div>";   
										 }
										...
										if (isset($_POST['llamadas']))
										{
										 ...
										 if(!isset($_GET["pagina"]))
										  ...
										  crear_tabla($listallama, $campos,'listafac','histocliecobro.php',false,"listafac_editar.php",
										  "listafac_eliminar.php","listafac.php","histocliecobro.php?id=$regis","vacio.php");
										  echo "<div style=\"padding:15px;\" align=\"center\">";
										  //paginacion ($num_pag,$total_registros,"histocliecobro.php?pagina=");
										  echo"</div>";   
										...
										if (isset($_POST['planes']))
										{
										 ...
										 if(!isset($_GET["pagina"]))
										  ...
										  crear_tabla($listaplan, $campos,'listafac','histocliecobro.php',false,"listafac_editar.php",
										  "listafac_eliminar.php","listafac.php","histocliecobro.php?id=$regis","vacio.php");
										  echo "<div style=\"padding:15px;\" align=\"center\">";
										  //paginacion ($num_pag,$total_registros,"histocliecobro.php?pagina=");
										  echo"</div>";   
										...
										if (isset($_POST['histopago']))
										{
										  ...
										  {
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=idenpacicobra.php">';    
											exit;  
									  	  }
									}
