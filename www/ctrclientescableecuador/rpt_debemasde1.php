...
<body>
	<div style="position:absolute;top:15px;border:1px no-solid;width:100%;height:98%;">
		...
		<table cellspacing="0" class="Tabla1" style="position:absolute;left:1px;top:130px;width:98%;">
			...
			<div style="position:absolute;left:10px;top:30px;width:650px;height:22px;z-index:1;">
			<span style="color:#000000;font-family:Arial;font-size:14px;"><strong>Cobrador:</strong>'.$xcobrador.'</span>
			</div>
			...
			if( mysql_num_rows($resultadofin)!=0)
	  		 ...
	  		 while ( $filad = mysql_fetch_array($resultadofin))
			 {
			  ...
			  //if($xttplan=="0100O1OO121")
                          //{
			  // $xapagar=intval($filad['parametroapa'])+30;
                          //}
			  //if($xttplan=="0401O822121")
                          //{
			  // $xapagar=intval($filad['parametroapa'])+30;
			  ...
			  //if($xttplan=="0501O822121")
                          //{
			  // $xapagar=intval($filad['parametroapa'])+50;
                          //}
			  //if($xttplan=="0703O522121")
                          //{
			  // $xapagar=intval($filad['parametroapa'])+200;
                          //}
			  //if($xttplan=="0804O422121")
                          //{
			  // $xapagar=intval($filad['parametroapa'])+100;
                          //}
    ...
    echo '
    <tr>
    <td style="position:absolute;left:5px;top:'.$cuentalin.'px;width:900px;height:37px;font-size:17px">Zona:'.$xzona.'</td>
    </tr>';
    $cuentalin=$cuentalin+30;
    echo '
    <tr>
