...
<title>Customerscabletv - Eliminar Marca </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Eliminar Modelo</a></h3>
							<div class="entry">
								<?php
									require_once("./logica/log_modelo.php");
									$tabla=log_obtener_modelo2($_GET["id"]);
									$registro=mysql_fetch_array($tabla);
									$mostrar_datos=true;
									if (isset ($_POST['cancelar']))
									{
										echo '<META HTTP-EQUIV="Refresh" Content="0; URL=modelo.php">';    
										exit;    
									}
									if (isset ($_POST['aceptar']))
									{
										
										$resulatado=log_eliminar_modelo($_GET["id"]);
										if ($resulatado==1)
										{
										...
										{	
											if ($resulatado=='1451')
											{
												...
												No se puede eliminar este modelo pues ya tiene movimientos.
												</div>';
											}
											else
											{
