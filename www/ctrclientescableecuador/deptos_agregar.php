...
<title>Customscabletv - Ingreso de registro de Estados </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Agregar un Estado</a></h3>
							<div class="entry">
								<?php
									...
									if (isset ($_POST['aceptar']))
									{
										if (isset($_POST['Codigo'])==false or $_POST['Codigo']=="")
										{
											...
											Debe ingresar el Codigo para el departamento que desea ingresar
											</div>';
											$insertar=false;
																													}
										...
										if ($insertar==true)
										{
											$resultado=log_insertar_deptos($_POST);
                 									IF($resultado==1){
