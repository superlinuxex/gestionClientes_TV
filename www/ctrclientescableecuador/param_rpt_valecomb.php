...
<title>S I C I O - Impresion de vales de combustible</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h2 class="title"><a href="#">Parametros para impresion vales de combustibles</a></h2>
							<div class="entry">
								<?php
									if (isset ($_POST['aceptar']))
									{
										...
										if ($insertar==true)
										{
											...
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=r_imprivalesco.php?
