...
<title>S I C I O - Editar Sub-Partida </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h2 class="title">Editar Sub-Partida de:</a></h2>
							<div class="entry">
								<?php
									require_once("./utils/validar_datos.php");
									require_once("logica/log_subpartidas.php");
									$tabla=log_obtener_subpartida($_GET["part"],$_GET["div"],$_GET["pro"],$_GET["s_part"]);
									...
									else
									{
										...
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=subpartidas.php?part='.$_GET["part"]."&div=".$_GET["div"]."&pro=".$_GET["pro"].'&s_part='.$_GET["s_part"].'">';    
											exit;  
									...
									switch ($mostrar_datos)
									{
										...
										case 'post':
											...
											{
												echo '<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#ce2700;">
												Debe ingresar los Abonos para la sub-partida que desea ingresar,puede digitar 0 (cero)
												</div>';
												$insertar=false;										
											}
											else{
											...
											if ($insertar==true)
											{
												$resultado=log_actualizar_subpartida($_POST,$_GET['part'],$_GET["div"],$_GET["pro"],$_GET['s_part']);
