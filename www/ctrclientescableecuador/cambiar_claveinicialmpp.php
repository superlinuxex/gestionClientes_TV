...
<title>ERVING-SPMPC - Cambio de Claves de Acceso </title>
	...
	<div id="header-wrapper">
		<div id="header">
			<div id="logo" align="center">
				<img src="imagenes/linea1optimpp.png" alt="logo"  border="0" align="texttop" />
			</div>
		</div>
	</div>
	<!-- Fin de encabezado -->
						...
						<div class="post">
							...
							<div class="entry">
								<?php
									...
									{
										echo '<META HTTP-EQUIV="Refresh" Content="0; URL=utils/cerrar_sesionmpp.php">';    
										exit;    
									}
