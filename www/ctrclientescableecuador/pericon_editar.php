...
<title>Customerscabletv - Editar peridos de contrato </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Editar periodos de contratos</a></h3>
							<div class="entry">
								<?php
									require_once("logica/log_pericon.php");
									$tabla=log_obtener_pericontrat($_GET["id"]);
									...
									switch ($mostrar_datos)
									{
										case 'get':
											...
											<td><input type="text" class="frm_txt_long" name="Meses" value="'.$registro['Meses'].'" /></td>
											</tr>
											<tr>
										...
										case 'post':
											...
											{
												echo '<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#ce2700;">
												Debe ingresar la descripcion del periodo
												</div>';
												$insertar=false;
											}
											...
											{
												echo '<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#ce2700;">
												Debe ingresar el periodo en meses
												</div>';
												$insertar=false;
											}
											...
											if ($insertar==true)
											{
												$resultado=log_actualizar_pericontrat($_POST,$_GET['id']);
											...
											<tr>
											<td>Tiempo de contrato en meses::</td>
											<td><input type="text" class="frm_txt_long" name="Meses" value="'.(isset($_POST['Meses'])?$_POST['Meses']:'').'" /></td>
											</tr>
											<tr>
