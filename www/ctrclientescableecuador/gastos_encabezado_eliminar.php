...
<title>Customerscabletv - Eliminar encabezado del gasto </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Eliminar o ajustar gasto</a></h3>
							<div class="entry">
								<?php
									...
									else
									{
										...
										{
											$resultado=log_ajustar_gasto2($_POST,$registro['Tipo']);
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=gastoselim.php">';    
											exit;  
										}
										...
										case 'get':
											...
											switch ($registro['Tipo'])
											{
												case '1':
													...
													<td>
													<select name="Lugarcon" disabled="true" class="frm_cmb">
													...
													<td>Proveedor:</td>
													<td>
													<select name="Proveedor" disabled="true" class="frm_cmb" />
													...
													<td>
													<select name="Codigoempl" disabled="true" class="frm_cmb" />
													...
													<td>
													<select name="Partida" disabled="true" class="frm_cmb_long" />
													...
													<td><input type="text" class="frm_txt" readonly="readonly" name="Descuento" value="'.$registro['Descuento'].'" /></td>
													</tr>
													...
													<tr>
													<td>Justificacion:</td>
													<td><input type="text" class="frm_txt_long"  readonly="readonly" name="Justificacion" value="'.$registro['Justificacion'].'" /></td>
													</tr>';
												...
												case '2':
													...
													<tr>
													<td>(+)Fovial:</td>
													<td><input type="text" class="frm_txt" readonly="readonly" name="Fovial" value="'.$registro['Fovial'].'" /></td>
													</tr>


													<tr>
													<td>(-)Renta retenida:</td>
													<td><input type="text" class="frm_txt" readonly="readonly" name="Renta" value="'.$registro['Renta'].'" /></td>
													</tr>
											...
											<input  type="submit" value="Ajustar gasto"  class="frm_btn" name="ajustar"/>
										...
										case 'post':
											switch ($registro['Tipo'])
											{
												case '1':
													...
													if ($Actualizar==true)
													{
														$resultado=log_eliminar_gasto2($_POST,$registro['Tipo']);
												...
												<tr>
												<td>(-) Descuento concedido:</td>
												<td><input type="text" class="frm_txt" readonly="readonly" name="Descuento" value="'.(isset($_POST['Descuento'])?$_POST['Descuento']:'').'" /></td>
												</tr>


												<tr>
												<td>(+)Fovial y Cotran:</td>
												<td><input type="text" class="frm_txt" readonly="readonly" name="Fovial" value="'.(isset($_POST['Fovial'])?$_POST['Fovial']:'').'" /></td>
												</tr>
												...
												<td><input type="text" class="frm_txt_long" readonly="readonly" name="Justificacion" value="'.(isset($_POST['Justifica'])?$_POST['Justificacion']:'').'" /></td>
												</tr>
												...
												<tr>
												<td>Numero de documento de compra:</td>
												<td><input type="text" class="frm_txt" readonly="readonly" name="Documento" value="'.(isset($_POST['Documento'])?$_POST['Documento']:'').'" /></td>
												</tr>

												
												<tr>
												<td>Fecha del documento de compra:</td>
												<td><input type="text" class="frm_txt" id="Fecha" readonly="readonly" name="Fecha" value="'.(isset($_POST['Fecha'])?$_POST['Fecha']:'').'"/></td>
												</tr>
												...
												<td><input type="text" class="frm_txt" readonly="readonly" name="Renta" value="'.(isset($_POST['Renta'])?$_POST['Renta']:'').'" /></td>
												</tr>
												...
												<td><input type="text" class="frm_txt" readonly="readonly" name="Fovial" hidden="true" value="'.(isset($_POST['Fovial'])?$_POST['Fovial']:'').'" /></td>
												
												<td><input type="text" class="frm_txt" readonly="readonly" name="Renta" hidden="true" value="'.(isset($_POST['Renta'])?$_POST['Renta']:'').'" /></td>
