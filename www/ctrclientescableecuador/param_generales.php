							...
							<div class="entry">
								<?php
									if (isset ($_POST['aceptar']))
									{
										...
										if ($insertar==true)
										{
											echo '<META HTTP-EQUIV="Refresh" Content="0; URL=rpt_genercli.php?
									...
									<td>
										<select name="Tipoinfo" class="frm_cmb_long">
											<option value="1" '.(isset($_POST['Tipoinfo'])?($_POST['Tipoinfo']==1?' selected="selected" ':''):'').'>Datos contractuales del cliente</option>
											<option value="2" '.(isset($_POST['Tipoinfo'])?($_POST['Tipoinfo']==2?' selected="selected" ':''):'').'>Datos de identificacion del cliente</option>
											<option value="3" '.(isset($_POST['Tipoinfo'])?($_POST['Tipoinfo']==3?' selected="selected" ':''):'').'>Datos de localizacion del cliente</option>
											<option value="4" '.(isset($_POST['Tipoinfo'])?($_POST['Tipoinfo']==4?' selected="selected" ':''):'').'>Datos de instalacion del cliente</option>
											<option value="5" '.(isset($_POST['Tipoinfo'])?($_POST['Tipoinfo']==5?' selected="selected" ':''):'').'>Meses de servicio a clientes desconectados</option>
											<option value="6" '.(isset($_POST['Tipoinfo'])?($_POST['Tipoinfo']==6?' selected="selected" ':''):'').'>Clientes con direcciones iguales</option>
											<option value="7" '.(isset($_POST['Tipoinfo'])?($_POST['Tipoinfo']==7?' selected="selected" ':''):'').'>Padron de tabla de clientes</option>
										</select>
									</td>
									</tr>
