...
<title>Customerscabletv - Eliminar periodos de contratos </title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Eliminar periodos de contratos</a></h3>
							<div class="entry">
								<?php
									...
									if (isset ($_POST['aceptar']))
									{
										...
										$resulatado=log_eliminar_pericontrat($_GET["id"]);
										if ($resulatado==1)
										{
										...
										{	
											if ($resulatado=='1451')
											{
												...
												No se puede eliminar este periodo pues ya tiene movimientos.
												</div>';
											}
											else
											{
									...
									if ($mostrar_datos==true)
									{
										...
										<td><input type="text" readonly="readonly" class="frm_txt" name="Meses" value="'.$registro['Meses'].'" /></td>
										</tr>
										<tr>
