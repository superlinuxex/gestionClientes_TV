...
<title>Customerscabletv- Mantenimiento de rango de numeros de facturas correlativos a utilizar</title>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Agregar rango de numeros de facturas correlativos a utilizar</a></h3>
							<div class="entry">
								<?php
									...
									if (isset ($_POST['aceptar']))
									{
										...
										if (isset($_POST['Sucursal'])==false or $_POST['Sucursal']=="")
										{
											echo '<div style="background:url(imagenes/msg_red.png) no-repeat; padding:10px 10px 10px 10px; Color:#000000;">
										...
										if ($insertar==true)
										{
											...
											$resultado=log_insertar_talonariocf($_POST,$bodx,$usux);
                 									IF($resultado==1){
