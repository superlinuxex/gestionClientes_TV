		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
							<h3 class="title">Agregar Detalle de ingreso de articulos de Articulos</a></h3>
							<div class="entry">
								<?php
									$marc1="SINMARCA";
									...
									if ($Encabezado['1']==1)
									{
										...
										if ($Encabezado['5']!="")
										{
											echo '&nbsp;&nbsp;Transferencia No.:&nbsp;'.$Encabezado['5'];
											echo '&nbsp; de Fecha:&nbsp;'.$Encabezado['8'];
									...
									if ($Encabezado['1']==2)
									{
										if ($Encabezado['10']!="")
										{
											echo '&nbsp;&nbsp;Devolución por técnico - Corresponde al Vale de salida No.:&nbsp;'.$Encabezado['10'];
											echo '&nbsp; de Fecha:&nbsp;'.$Encabezado['8'];
									...
									if (isset ($_POST['aceptar']))
									{
										...
										if ($insertar==true)
										{
											...
											if (log_validar_entradaasuc($codigo_entrada)==0)
											{
												log_insertar_entradaasuc($Encabezado);
											}
											$resulatado=log_insertar_entradaasuc_detalle($_POST,$bodega,$Encabezado);
											$resulatado=log_insertar_existencia($bodega,$_POST['Producto'],$_POST['Cantidad'],$_POST['CodEntrada'],$_POST['Estado']);
									...
									<tr>
									<td>Cantidad de artículos recibidos:</td>
